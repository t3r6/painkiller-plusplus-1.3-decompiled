...
function Hud:LoadData()
  ...
  for he = 0, 60 do
      self._matHealthQW3D[he + 1] =
          MATERIAL.Create("3Dico/Health/Health_" .. he, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  end
  ...
  for ar = 0, 64 do
      self._matArmorYellowQW3D[ar + 1] =
          MATERIAL.Create("3Dico/Armor/Gold/Gold_" .. ar, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matArmorBronzeQW3D[ar + 1] =
          MATERIAL.Create("3Dico/Armor/Copper/Copper_" .. ar, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matArmorSilverQW3D[ar + 1] =
          MATERIAL.Create("3Dico/Armor/Silver/Silver_" .. ar, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matArmorNormalQW3D[ar + 1] =
          MATERIAL.Create("3Dico/Armor/Normal/Normal_" .. ar, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  end
  ...
  for cw = 0, 31 do
      self._matShotgunIcon3D[cw + 1] =
          MATERIAL.Create("3Dico/Weapons/ShotGun/ShotGun_" .. cw, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matPainKillerIcon3D[cw + 1] =
          MATERIAL.Create("3Dico/Weapons/PainKiller/PainKiller_" .. cw, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matStakeIcon3D[cw + 1] =
          MATERIAL.Create("3Dico/Weapons/Stake/Stake_" .. cw, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matMiniGunIcon3D[cw + 1] =
          MATERIAL.Create("3Dico/Weapons/MiniGun/MiniGun_" .. cw, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matElectroIcon3D[cw + 1] =
          MATERIAL.Create("3Dico/Weapons/Electro/Electro_" .. cw, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matRifleIcon3D[cw + 1] =
          MATERIAL.Create("3Dico/Weapons/Rifle/Rifle_" .. cw, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matBoltIcon3D[cw + 1] =
          MATERIAL.Create("3Dico/Weapons/Bolt/Bolt_" .. cw, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  end
  ...
  self._matKeysNumDecimal_fr =
      MATERIAL.Create("Help/fr/Crosshair/NumDecimal", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  ...
  self._matKeysNumDecimal_en =
      MATERIAL.Create("Help/en/Crosshair/NumDecimal", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  ...
  for am = 0, 15 do
      self._matAmmoOpenIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/PKh/PKh_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListShellIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Shell/Shell_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListKolkiIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Stake/Stake_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListRocketIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Grenade/Grenade_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListSzurikenIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Szuriken/Szuriken_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListrifleIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Rifle/Rifle_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListBoltyIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Bolt/Bolt_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoCloseIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/PKf/PKf_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListFreezerIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Freezer/Freezer_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListRocketIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Grenade/Grenade_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListMiniIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/Minigun/Minigun_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matAmmoListKulkiIconQW3D[am + 1] =
          MATERIAL.Create("3Dico/Ammo/HeaterB/HeaterB_" .. am, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  end
  for el = 0, 26 do
      self._matAmmoListElectroIconQW3D[el + 1] =
          MATERIAL.Create("3Dico/Ammo/Electro/Electro_" .. el, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  end
  for fl = 0, 52 do
      self._matAmmoListflameIconQW3D[fl + 1] =
          MATERIAL.Create("3Dico/Ammo/Flame/Rtf_" .. fl, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  end
  ...
  if Cfg.Crosshair then
      ...
      self._matCrosshair =
          MATERIAL.Create(self._crosshairs[Cfg.Crosshair], TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  ...
  self._matDemonsGrey =
      MATERIAL.Create("HUD/demon count szary30 % transp", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  ...
  for i = 0, 9 do
      ...
      self._matDigitsRed[i + 1] =
          MATERIAL.Create("HUD/numbers/" .. i .. "_cz", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matDigitsT[i + 1] = MATERIAL.Create("SHud/numbers/" .. i, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matDigitsTRed[i + 1] =
          MATERIAL.Create("SHud/numbers/" .. i .. "_cz", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matDigitsBT[i + 1] = MATERIAL.Create("BHud/numbers/" .. i, TextureFlags.NoLOD + TextureFlags.NoMipMaps)
      self._matDigitsBTRed[i + 1] =
          MATERIAL.Create("BHud/numbers/" .. i .. "_cz", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  end
  ...
  self._matCompassArrShadow =
      MATERIAL.Create("HUD/kompas/strzalka_kompas_cien", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  self._matCompassArrGlow =
      MATERIAL.Create("HUD/kompas/strzalka_glow_next", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
  ...
  self._matDemonCross =
      MATERIAL.Create("HUD/crossy/crosshair_demon_morph", TextureFlags.NoLOD + TextureFlags.NoMipMaps)
...
function Hud:Render(delta)
  ...
  if Game and 0 < Game._voteTimeLeft then
      ...
      local currentvote =
          "Vote(" ..
          string.format("%02d", Game._voteTimeLeft) ..
              "): '" .. Game._voteCmd .. " " .. Game._voteParams .. "'  yes(" .. yesVotes .. ") no(" .. noVotes .. ")"
  ...
  if Game.GMode == GModes.SingleGame then
      self:Quad(
          self._matPentagram,
          (512 - Cfg.HUDSize * 105) * w / 1024,
          Cfg.HUDSize * 14 * h / 768,
          Cfg.HUDSize,
          false
      )
  ...
  if MPCfg.GameMode ~= "Instagib" and MPCfg.GameMode ~= "ICTF" then
      if Cfg.HUD_HudStyle == 0 then
          ...
          self:QuadTrans(
              self._matHUDRight,
              (1024 - Cfg.HUDSize * sizex) * w / 1024,
              (768 - Cfg.HUDSize * sizey) * h / 768,
              Cfg.HUDSize,
              false,
              trans
          )
      ...
      if Cfg.HUD_HudStyle == 0 then
          self:Quad(
              self._matHealth,
              Cfg.HUDSize * 17 * w / 1024,
              (768 + Cfg.HUDSize * 14 - Cfg.HUDSize * sizey) * h / 768,
              Cfg.HUDSize,
              false
          )
      end
  ...
  if Player then
      if not Player._died then
          if not Hud.NoCrosshair then
              ...
              if
                  type(w) == "number" and w <= 7 and 1 <= w and Player._CurWeaponIndex == w and
                      Player._CurWeaponIndex == w
               then
                  if INP.Key(Keys.NumDecimal) == 2 then
                      if Cfg.SetCrossPerWeapons == 8 then
                          ...
                          HUD.PrintXY(
                              (w - HUD.GetTextWidth(tonumber(string.format("%03d", CrosshairSize[8])) .. "%")) / 2 + 1,
                              h / 2 + txtposy + 1,
                              tonumber(string.format("%03d", CrosshairSize[8])) .. "%",
                              "courbd",
                              15,
                              15,
                              15,
                          ...
                          HUD.PrintXY(
                              (w - HUD.GetTextWidth(tonumber(string.format("%03d", CrosshairSize[8])) .. "%")) / 2,
                              h / 2 + txtposy,
                              tonumber(string.format("%03d", CrosshairSize[8])) .. "%",
                              "courbd",
                              0,
                          ...
                          HUD.SetFont("courbd", 14)
                          HUD.PrintXY(
                              (w - HUD.GetTextWidth(tonumber(string.format("%03d", CrosshairSize[w])) .. "%")) / 2 + 1,
                              h / 2 + txtposy + 1,
                              tonumber(string.format("%03d", CrosshairSize[w])) .. "%",
                              "courbd",
                              15,
                              15,
                              15,
                          ...
                          HUD.PrintXY(
                              (w - HUD.GetTextWidth(tonumber(string.format("%03d", CrosshairSize[w])) .. "%")) / 2,
                              h / 2 + txtposy,
                              tonumber(string.format("%03d", CrosshairSize[w])) .. "%",
                              "courbd",
                              0,
          ...
          if not statsoverlay then
              if not Hud.NoCrosshair and not Cfg.CustomCrosshairLocation then
                  if self._timeCrossHit then
                      self:QuadRGBA(
                          ...
                          self.CrossScale,
                          true,
                          Cfg.CrosshairHit_RGB[1],
                          Cfg.CrosshairHit_RGB[2],
                          Cfg.CrosshairHit_RGB[3],
                          Cfg.CrosshairHit_Trans
                      )
                  else
                      self:QuadRGBA(
                          self._matCrosshair,
              ...
              if not Hud.NoCrosshair and Cfg.CustomCrosshairLocation then
                  if self._timeCrossHit then
                      ...
                      self:QuadRGBA(
                          self._matCrosshair,
                          w * Cfg.CustomCrosshairLocationX,
                          h * Cfg.CustomCrosshairLocationY,
                          self.CrossScale,
                          true,
                          Cfg.CrosshairR,
                          Cfg.CrosshairG,
          ...
          if
              Cfg.HUD_AmmoList ~= 0 and MPCfg.GameMode ~= "Voosh" and MPCfg.GameMode ~= "People Can Fly" and
                  MPCfg.GameMode ~= "Instagib" and
                  MPCfg.GameMode ~= "ICTF"
           then
              self:AmmoListOriOn()
          end
          ...
          if
              Cfg.HUD_FragMessage and fragmessagestart < Game.currentTime and fragmessageend > Game.currentTime and
                  fragmessageend > Game.currentTime
           then
      ...
      if MPCfg.GameMode ~= "Instagib" and MPCfg.GameMode ~= "ICTF" then
          ...
          if Cfg.HUD_HudStyle == 0 then
              if Player.ArmorType == 0 then
                  self:Quad(
                      self._matArmorNormal,
                      Cfg.HUDSize * 17 * w / 1024,
                      (768 + Cfg.HUDSize * 49 - Cfg.HUDSize * sizey) * h / 768,
                      Cfg.HUDSize,
                      false
                  )
      ...
      elseif Cfg.PositioningSystem == 5 and INP.Key(Keys.Home) == 3 then
          ...
          local morethantwo = 0
          if
              Game.currentTime * 2 >= Hud.MedalNoMercyIconStart and Game.currentTime * 2 <= Hud.MedalNoMercyIconEnd and
                  Cfg.HUD_Medal_NoMercy_Icon
           then
          ...
          if
              Game.currentTime * 2 >= Hud.MedalGoodIconStart and Game.currentTime * 2 <= Hud.MedalGoodIconEnd and
                  Cfg.HUD_Medal_Good_Icon
           then
          ...
          if
              Game.currentTime * 2 >= Hud.MedalSweetIconStart and Game.currentTime * 2 <= Hud.MedalSweetIconEnd and
                  Cfg.HUD_Medal_Sweet_Icon
           then
          ...
          if
              Game.currentTime * 2 >= Hud.MedalStylishIconStart and Game.currentTime * 2 <= Hud.MedalStylishIconEnd and
                  Cfg.HUD_Medal_Stylish_Icon
           then
      ...
      if Game.GMode == GModes.SingleGame then
          self:DrawDigitsText(
              (512 - Cfg.HUDSize * 202) * w / 1024,
              Cfg.HUDSize * 14 * h / 768,
              string.format("%05d", Game.BodyCountTotal),
              0.8 * Cfg.HUDSize
          )
          self:DrawDigitsText(
              (512 + Cfg.HUDSize * 105) * w / 1024,
              Cfg.HUDSize * 14 * h / 768,
              string.format("%05d", Player.SoulsCount),
              0.8 * Cfg.HUDSize,
              5 - Game.Demon_HowManyCorpses
          )
      end
      ...
      if MPCfg.GameMode ~= "Instagib" and MPCfg.GameMode ~= "ICTF" then
          if Cfg.HUD_HudStyle == 0 then
              self:DrawDigitsText1(
                  Cfg.HUDSize * 52 * w / 1024,
                  (768 + Cfg.HUDSize * 16 - Cfg.HUDSize * sizey) * h / 768,
                  string.sub(string.format("%03d", he), -3),
                  0.9 * Cfg.HUDSize,
          ...
          if Cfg.HUD_HudStyle == 0 then
              self:DrawDigitsText1(
                  Cfg.HUDSize * 52 * w / 1024,
                  (768 + Cfg.HUDSize * 50 - Cfg.HUDSize * sizey) * h / 768,
                  string.sub(string.format("%03d", armor), -3),
                  0.9 * Cfg.HUDSize,
                  Player.ArmorWarning
              )
          end
  ...
  if Game.GMode == GModes.SingleGame then
      ...
      if Game.MegaBossHealth and Game.MegaBossHealthMax then
          ...
          if Game.CurrChapter == 1 and not Game.AddOn then
              self:Quad(
                  self._matBossGiant,
                  (512 - Cfg.HUDSize * 48) * w / 1024,
                  Cfg.HUDSize * 10 * h / 768,
                  Cfg.HUDSize,
                  false
              )
...
function Hud:DrawSingleStat(index, name, val, total, bonus, show_star)
  ...
  if val < 1000 then
      ...
      if bonus and 0 < bonus then
          HUD.PrintXY(
              maxPos + HUD.GetTextWidth(string.format("%03d", total)),
              y,
      ...
      if bonus and 0 < bonus then
          HUD.PrintXY(
              maxPos + diff + HUD.GetTextWidth(string.format("%03d", total)),
              y,
              string.format("+%d", bonus),
              "timesbd",
              120,
...
function Hud:RenderSPStats()
  ...
  HUD.PrintXY(
      w / 2 + statLen / 2 - HUD.GetTextWidth(cardText),
      h / 2 + fh * 8 - 8 * w / 768,
      cardText,
      "timesbd",
      colorMin[1],
...
function Hud:DrawSingleStat2(index, name, val, total, bonus, show_star, diff)
  ...
  if diff then
      HUD.PrintXY(
          maxPos + HUD.GetTextWidth("000000000"),
          y,
...
function Hud_RenderLevelStats()
  ...
  if diff[stats.TimeDiff + 1] then
      HUD.PrintXY(
          maxPos + HUD.GetTextWidth("000000000"),
          h / 2 - fh * 5,
          string.format("(%s)", diff[stats.TimeDiff + 1]),
          "timesbd",
          colorTxt[1],
          colorTxt[2],
          colorTxt[3],
  ...
  Hud:DrawSingleStat2(
      1,
      TXT.SPStats.MonstersKilled,
      stats.MonstersKilled,
      stats.TotalMonsters,
      nil,
      false,
      diff[stats.MonstersDiff + 1]
  )
  Hud:DrawSingleStat2(
      2,
      TXT.SPStats.SoulsCollected,
      stats.SoulsCollected,
      stats.TotalSouls,
      nil,
      false,
      diff[stats.SoulsDiff + 1]
  )
  Hud:DrawSingleStat2(
      3,
      TXT.SPStats.GoldFound,
      ...
      stats.BonusItems,
      false,
      diff[stats.GoldDiff + 1]
  )
  HUD.DrawQuadRGBA(nil, 300 * w / 1024, h / 2 - 5 * h / 768 - fh / 2, 440 * w / 1024, 1, 230, 161, 97, 255)
  Hud:DrawSingleStat2(
      5,
      TXT.SPStats.ArmorFound,
      stats.ArmorsFound,
      stats.TotalArmors,
      nil,
      show_stars,
      diff[stats.ArmorsDiff + 1]
  )
  Hud:DrawSingleStat2(
      6,
      TXT.SPStats.HolyItemsFound,
      stats.HolyItemsFound,
      stats.TotalHolyItems,
      nil,
      show_stars,
      diff[stats.HolyDiff + 1]
  )
  Hud:DrawSingleStat2(
      7,
      TXT.SPStats.AmmoFound,
      stats.AmmoFound,
      stats.TotalAmmo,
      nil,
      show_stars,
      diff[stats.AmmoDiff + 1]
  )
  Hud:DrawSingleStat2(
      8,
      TXT.SPStats.ObjectsDestroyed,
      stats.ObjectsDestroyed,
      stats.TotalObjects,
      nil,
      show_stars,
      diff[stats.ObjectsDiff + 1]
  )
  Hud:DrawSingleStat2(
      9,
      TXT.SPStats.SecretsFound,
      stats.SecretsFound,
      stats.TotalSecrets,
      nil,
      show_stars,
      diff[stats.SecretsDiff + 1]
  )
  HUD.PrintXY(
      -1,
      h / 2 + fh * 6 - 8 * w / 768,
  ...
  HUD.PrintXY(
      -1,
      h / 2 + fh * 7 - 8 * w / 768,
      PMENU.MapGetCurrLevelCardCondition(),
      "timesbd",
      colorMax[1],
      colorMax[2],
      colorMax[3],
...
function Hud:RenderCompass()
  ...
  if check and self._nearestIsCheckpoint then
      if 0 >= self._glowTrans and time - self._glowStart > 1.5 then
          local dist =
              Dist3D(
              self._nearestCheckPoint.Pos.X,
              self._nearestCheckPoint.Pos.Y,
              self._nearestCheckPoint.Pos.Z,
              Player._groundx,
              Player._groundy,
              Player._groundz
          )
  ...
  if not check then
      self:QuadRot(
          self._matCompassArrShadow,
          500 * w / 1024,
          Cfg.HUDSize * 62 * h / 768,
          Cfg.HUDSize,
          self._arrowRot,
          516 * w / 1024,
          Cfg.HUDSize * 58 * h / 768
      )
      self:QuadRot(
          self._matCompassArrow,
          495 * w / 1024,
          Cfg.HUDSize * 58 * h / 768,
          Cfg.HUDSize,
          self._arrowRot,
          511 * w / 1024,
          Cfg.HUDSize * 54 * h / 768
      )
  else
      self:QuadRot(
          self._matCompassArrShadow,
...
function Hud:RenderUpDown()
  ...
  if self.upDown == 0 then
      ...
      self:QuadTrans(
          self._matCompassDown,
          (512 - 17 * Cfg.HUDSize) * w / 1024,
          87 * Cfg.HUDSize * h / 768,
          Cfg.HUDSize,
          false,
          trans
      )
