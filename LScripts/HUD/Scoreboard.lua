...
function Hud:DrawScoreboard()
    ...
    HUD.PrintXY(
        w * timedate.x,
        h * timedate.y,
        "PK++ MOD Client - " .. os.date("%d/%m/%y %X", os.time()),
        font,
        255,
        255,
        255,
    ...
    if (not MPGameRules[MPCfg.GameMode] or not MPGameRules[MPCfg.GameMode].Teams) and MPCfg.GameMode ~= "Duel" then
        ...
        HUD.PrintXY(
            w * ffateampanel.x + w * panelfraction.score * ffateampanel.w,
            h * ffateampanel.y + ffascoredelta + vspace,
            "Score",
            font,
            255,
            255,
        ...
        HUD.PrintXY(
            w * ffateampanel.x + w * panelfraction.net * ffateampanel.w,
            h * ffateampanel.y + ffascoredelta + vspace,
            "NET",
            font,
            255,
        ...
        HUD.PrintXY(
            w * ffateampanel.x + w * panelfraction.ping * ffateampanel.w,
            h * ffateampanel.y + ffascoredelta + vspace,
            "Ping",
            font,
            255,
        ...
        HUD.PrintXY(
            w * ffateampanel.x + w * panelfraction.time * ffateampanel.w,
            h * ffateampanel.y + ffascoredelta + vspace,
            "Time",
            font,
            255,
        ...
        HUD.PrintXY(
            w * ffateampanel.x + w * panelfraction.name * ffateampanel.w,
            h * ffateampanel.y + ffascoredelta + vspace,
            "Name",
            font,
            255,
            ...
            if Game.PlayerStats[ID].Spectator == 0 then
                if Player and Player.ClientID == ID then
                    HUD.DrawQuadRGBA(
                        Hud._matBluePix,
                        w * ffateampanel.x,
                        h * ffateampanel.y + ffascoredelta,
                        w * ffateampanel.w,
                        mediumfont,
                        255,
                        255,
                ...
                HUD.PrintXY(
                    w * ffateampanel.x + w * panelfraction.net * ffateampanel.w,
                    h * ffateampanel.y + ffascoredelta + vspace,
                    Game.PlayerStats[ID].Score - Game.PlayerStats[ID].Deaths,
                    font,
                    255,
                    255,
                    255,
                ...
                if Cfg.ScoreboardShowPacketLoss then
                    HUD.PrintXY(
                        w * ffateampanel.x + w * panelfraction.ping * ffateampanel.w,
                        h * ffateampanel.y + ffascoredelta + vspace,
                        Game.PlayerStats[ID].Ping .. " (" .. Game.PlayerStats[ID].PacketLoss .. ")",
                        font,
                        255,
                        255,
                        255,
                ...
                HUD.PrintXY(
                    w * ffateampanel.x + w * panelfraction.time * ffateampanel.w,
                    h * ffateampanel.y + ffascoredelta + vspace,
                    string.format("%02d", (INP.GetTime() - MPSTATS.GetPlayerTime(ID)) / 60),
                    font,
                    255,
                    255,
                    255,
                ...
                local playerstate = ""
                if
                    Game.PlayerStats[ID].State == 0 and
                        (MPCfg.GameState == GameStates.WarmUp or MPCfg.GameState == GameStates.Counting)
                 then
                    playerstate = "(-)"
                end
                if
                    Game.PlayerStats[ID].State == 1 and
                        (MPCfg.GameState == GameStates.WarmUp or MPCfg.GameState == GameStates.Counting)
                 then
                    playerstate = "(R)"
                end
                if
                    Game.PlayerStats[ID].State == 2 and
                        (MPCfg.GameState == GameStates.WarmUp or MPCfg.GameState == GameStates.Counting)
                 then
                    playerstate = "(B)"
                end
                ...
                HUD.PrintXY(
                    w * ffateampanel.x + w * panelfraction.state * ffateampanel.w,
                    h * ffateampanel.y + ffascoredelta + vspace,
                    playerstate,
                    font,
                    255,
        ...
        HUD.PrintXY(
            w * specteampanel.x + w * panelfraction.score * specteampanel.w,
            h * specteampanel.y + specscoredelta + vspace,
            "Score",
            font,
            255,
            255,
        ...
        HUD.PrintXY(
            w * specteampanel.x + w * panelfraction.net * specteampanel.w,
            h * specteampanel.y + specscoredelta + vspace,
            "NET",
            font,
            255,
        ...
        HUD.PrintXY(
            w * specteampanel.x + w * panelfraction.ping * specteampanel.w,
            h * specteampanel.y + specscoredelta + vspace,
            "Ping",
            font,
            255,
        ...
        HUD.PrintXY(
            w * specteampanel.x + w * panelfraction.time * specteampanel.w,
            h * specteampanel.y + specscoredelta + vspace,
            "Time",
            font,
            255,
        ...
        HUD.PrintXY(
            w * specteampanel.x + w * panelfraction.name * specteampanel.w,
            h * specteampanel.y + specscoredelta + vspace,
            "Name",
            font,
            255,
        ...
        for id, ps in Game.PlayerStats, nil do
            if ps.Spectator == 1 then
                ...
                HUD.PrintXY(
                    w * specteampanel.x + w * panelfraction.time * specteampanel.w,
                    h * specteampanel.y + specscoredelta + vspace,
                    string.format("%02d", (INP.GetTime() - MPSTATS.GetPlayerTime(ps.ClientID)) / 60),
                    font,
                    255,
                    255,
                    255,
        ...
        HUD.PrintXY(
            w * redscorepanel.x + w * scorefraction.score * redscorepanel.w,
            h * redscorepanel.y + h * redscorepanel.d * 0.1,
            redscore,
            bigfont,
            255,
            255,
        ...
        HUD.PrintXY(
            w * redscorepanel.x + w * scorefraction.ping * redscorepanel.w,
            h * redscorepanel.y + largefont / 1.5,
            "Av. Ping: " .. redping,
            font,
            255,
            255,
        ...
        HUD.PrintXY(
            w * redscorepanel.x + w * scorefraction.count * redscorepanel.w,
            h * redscorepanel.y + largefont / 1.5,
            "Players: " .. redcount,
            font,
            255,
        ...
        HUD.PrintXY(
            w * bluescorepanel.x + w * scorefraction.score * bluescorepanel.w,
            h * bluescorepanel.y + h * bluescorepanel.d * 0.1,
            bluescore,
            bigfont,
            255,
            255,
        ...
        HUD.PrintXY(
            w * bluescorepanel.x + w * scorefraction.ping * bluescorepanel.w,
            h * bluescorepanel.y + largefont / 1.5,
            "Av. Ping: " .. blueping,
            font,
            255,
            255,
        ...
        HUD.PrintXY(
            w * bluescorepanel.x + w * scorefraction.count * bluescorepanel.w,
            h * bluescorepanel.y + largefont / 1.5,
            "Players: " .. bluecount,
            font,
            255,
        ...
        HUD.PrintXY(
            w * redteampanel.x + w * panelfraction.score * redteampanel.w,
            h * redteampanel.y + redscoredelta + vspace,
            "Score",
            font,
            255,
            255,
        ...
        HUD.PrintXY(
            w * redteampanel.x + w * panelfraction.net * redteampanel.w,
            h * redteampanel.y + redscoredelta + vspace,
            "NET",
            font,
            255,
        ...
        HUD.PrintXY(
            w * redteampanel.x + w * panelfraction.ping * redteampanel.w,
            h * redteampanel.y + redscoredelta + vspace,
            "Ping",
            font,
            255,
        ...
        HUD.PrintXY(
            w * redteampanel.x + w * panelfraction.time * redteampanel.w,
            h * redteampanel.y + redscoredelta + vspace,
            "Time",
            font,
            255,
        ...
        HUD.PrintXY(
            w * redteampanel.x + w * panelfraction.name * redteampanel.w,
            h * redteampanel.y + redscoredelta + vspace,
            "Name",
            font,
            255,
        ...
        for pie, ID in redidlist, nil do
            if
                Game.PlayerStats[ID].Spectator == 0 and Game.PlayerStats[ID].Team == 0 and MPCfg.GameMode ~= "Duel" or
                    MPCfg.GameMode == "Duel" and Game.PlayerStats[ID].ClientID == dueller2
             then
                if Player and Player.ClientID == ID then
                    HUD.DrawQuadRGBA(
                        Hud._matBluePix,
                        w * redteampanel.x,
                        h * redteampanel.y + redscoredelta,
                        w * redteampanel.w,
                        mediumfont,
                        255,
                        255,
                ...
                HUD.PrintXY(
                    w * redteampanel.x + w * panelfraction.state * redteampanel.w,
                    h * redteampanel.y + redscoredelta + vspace,
                    playerstate,
                    font,
                    255,
        ...
        HUD.PrintXY(
            w * blueteampanel.x + w * panelfraction.score * blueteampanel.w,
            h * blueteampanel.y + bluescoredelta + vspace,
            "Score",
            font,
            255,
            255,
        ...
        HUD.PrintXY(
            w * blueteampanel.x + w * panelfraction.net * blueteampanel.w,
            h * blueteampanel.y + bluescoredelta + vspace,
            "NET",
            font,
            255,
        ...
        HUD.PrintXY(
            w * blueteampanel.x + w * panelfraction.ping * blueteampanel.w,
            h * blueteampanel.y + bluescoredelta + vspace,
            "Ping",
            font,
            255,
        ...
        HUD.PrintXY(
            w * blueteampanel.x + w * panelfraction.time * blueteampanel.w,
            h * blueteampanel.y + bluescoredelta + vspace,
            "Time",
            font,
            255,
        ...
        HUD.PrintXY(
            w * blueteampanel.x + w * panelfraction.name * blueteampanel.w,
            h * blueteampanel.y + bluescoredelta + vspace,
            "Name",
            font,
            255,
        ...
        for pie, ID in blueidlist, nil do
            if
                Game.PlayerStats[ID].Spectator == 0 and Game.PlayerStats[ID].Team == 1 and MPCfg.GameMode ~= "Duel" or
                    MPCfg.GameMode == "Duel" and Game.PlayerStats[ID].ClientID == dueller1
             then
                if Player and Player.ClientID == ID then
                    HUD.DrawQuadRGBA(
                        Hud._matRedPix,
                        w * blueteampanel.x,
                        h * blueteampanel.y + bluescoredelta,
                        w * blueteampanel.w,
                        mediumfont,
                        255,
                        255,
                ...
                HUD.PrintXY(
                    w * blueteampanel.x + w * panelfraction.state * blueteampanel.w,
                    h * blueteampanel.y + bluescoredelta + vspace,
                    playerstate,
                    font,
                    255,
        ...
        if 0 < numberofspecs then
            ...
            HUD.PrintXY(
                w * spec1teampanel.x + w * panelfraction.score * spec1teampanel.w,
                h * spec1teampanel.y + spec1scoredelta + vspace,
                "Score",
                font,
                255,
                255,
            ...
            HUD.PrintXY(
                w * spec1teampanel.x + w * panelfraction.net * spec1teampanel.w,
                h * spec1teampanel.y + spec1scoredelta + vspace,
                "NET",
                font,
                255,
            ...
            HUD.PrintXY(
                w * spec1teampanel.x + w * panelfraction.ping * spec1teampanel.w,
                h * spec1teampanel.y + spec1scoredelta + vspace,
                "Ping",
                font,
                255,
            ...
            HUD.PrintXY(
                w * spec1teampanel.x + w * panelfraction.time * spec1teampanel.w,
                h * spec1teampanel.y + spec1scoredelta + vspace,
                "Time",
                font,
                255,
            ...
            HUD.PrintXY(
                w * spec1teampanel.x + w * panelfraction.name * spec1teampanel.w,
                h * spec1teampanel.y + spec1scoredelta + vspace,
                " Name",
                font,
                255,
                ...
                if ps.Spectator == 1 then
                    if Player and Player.ClientID == ps.ClientID then
                        HUD.DrawQuadRGBA(
                            Hud._matGreenPix,
                            w * spec1teampanel.x,
                            h * spec1teampanel.y + spec1scoredelta,
                            w * spec1teampanel.w,
                            mediumfont,
                            255,
                            255,
            ...
            if 1 < numberofspecs then
                ...
                HUD.PrintXY(
                    w * spec2teampanel.x + w * panelfraction.score * spec2teampanel.w,
                    h * spec2teampanel.y + spec2scoredelta + vspace,
                    "Score",
                    font,
                    255,
                    255,
                ...
                HUD.PrintXY(
                    w * spec2teampanel.x + w * panelfraction.net * spec2teampanel.w,
                    h * spec2teampanel.y + spec2scoredelta + vspace,
                    "NET",
                    font,
                    255,
                ...
                HUD.PrintXY(
                    w * spec2teampanel.x + w * panelfraction.ping * spec2teampanel.w,
                    h * spec2teampanel.y + spec2scoredelta + vspace,
                    "Ping",
                    font,
                    255,
                ...
                HUD.PrintXY(
                    w * spec2teampanel.x + w * panelfraction.time * spec2teampanel.w,
                    h * spec2teampanel.y + spec2scoredelta + vspace,
                    "Time",
                    font,
                    255,
                ...
                HUD.PrintXY(
                    w * spec2teampanel.x + w * panelfraction.name * spec2teampanel.w,
                    h * spec2teampanel.y + spec2scoredelta + vspace,
                    "Name",
                    font,
                    255,
                    ...
                    if ps.Spectator == 1 and odd == 1 then
                        if Player and Player.ClientID == ps.ClientID then
                            HUD.DrawQuadRGBA(
                                Hud._matGreenPix,
                                w * spec2teampanel.x,
                                h * spec2teampanel.y + spec2scoredelta,
                                w * spec2teampanel.w,
                                mediumfont,
                                255,
                                255,
