...
function Hud:DrawScores(clientid)
  ...
  if Player and Cfg.PositioningSystem == 1 then
      ...
      if
          INP.Key(Keys.Num8) == 3 or INP.Key(Keys.Num6) == 3 or INP.Key(Keys.Num4) == 3 or INP.Key(Keys.Num2) == 3 or
      ...
      if INP.Key(Keys.Home) == 2 then
          ...
          if INP.Key(Keys.NumMultiply) == 1 then
              if
                  scoresposxysav[1][1] == 0 and scoresposxysav[1][2] == 0 and scoresposxysav[2][1] == 0 and
                      scoresposxysav[2][2] == 0
               then
          ...
          if INP.Key(Keys.NumDivide) == 1 then
              if
                  (scoresposxy[1][1] == 50 and scoresposxy[2][1] == 50 or
                      scoresposxy[1][1] == 974 and scoresposxy[2][1] == 974) and
                      (scoresposxy[1][2] == 733 and scoresposxy[2][2] == 683 or
                          scoresposxy[1][2] == 683 and scoresposxy[2][2] == 733)
               then
  ...
  if
      scoresposxy[1][1] == 50 and scoresposxy[2][1] == 50 and
          (scoresposxy[1][2] == 733 and scoresposxy[2][2] == 683 or
              scoresposxy[1][2] == 683 and scoresposxy[2][2] == 733)
   then
      scoresposxy[1][1] = 974
  ...
  HUD.DrawQuadRGBA(
      nil,
      (1024 - scposxy1[3] - 80 * scsizehud / 2) * w / 1024,
      (768 - scposxy1[1] - 50 * scsizehud / 2) * h / 768,
      80 * scsizehud * w / 1024,
      50 * scsizehud * h / 768,
      cb[1],
      cb[2],
  ...
  HUD.DrawQuadRGBA(
      nil,
      (1024 - scposxy2[3] - 80 * scsizehud / 2) * w / 1024,
      (768 - scposxy2[1] - 50 * scsizehud / 2) * h / 768,
      80 * scsizehud * w / 1024,
      50 * scsizehud * h / 768,
      cr[1],
      cr[2],
  ...
  if MPGameRules[MPCfg.GameMode].Teams then
      if gteam1Score < 0 then
          Hud:QuadTrans(
              matminus,
              (1024 - (scposxy1[3] + scx) - 80 * scsizehud / 2) * w / 1024,
              (768 - scposxy1[5] - 50 * scsizehud / 2) * h / 768,
              scsizehud * 1.4,
              false,
              255
          )
      ...
      if gteam2Score < 0 then
          Hud:QuadTrans(
              matminus,
              (1024 - (scposxy2[3] + scx) - 80 * scsizehud / 2) * w / 1024,
              (768 - scposxy2[5] - 50 * scsizehud / 2) * h / 768,
              scsizehud * 1.4,
              false,
              255
          )
      ...
      Hud:DrawDigitsText1(
          (1024 - scposxy1[4] - 80 * scsizehud / 2) * w / 1024,
          (768 - scposxy1[2] - 50 * scsizehud / 2) * h / 768,
          string.format("%3d", gamet1),
          0.9 * scsizehud,
          nil,
          colord[1],
          colord[2],
      ...
      Hud:DrawDigitsText1(
          (1024 - scposxy2[4] - 80 * scsizehud / 2) * w / 1024,
          (768 - scposxy2[2] - 50 * scsizehud / 2) * h / 768,
          string.format("%3d", gamet2),
          0.9 * scsizehud,
          nil,
          colord[1],
          colord[2],
      ...
      Hud:DrawDigitsText1(
          (1024 - scposxy1[4] - 80 * scsizehud / 2) * w / 1024,
          (768 - scposxy1[2] - 50 * scsizehud / 2) * h / 768,
          string.format("%3d", currentplayerscore),
          0.9 * scsizehud,
          nil,
          colord[1],
          colord[2],
      ...
      if MPCfg.GameMode == "Duel" then
          ...
          Hud:DrawDigitsText1(
              (1024 - scposxy2[4] - 80 * scsizehud / 2) * w / 1024,
              (768 - scposxy2[2] - 50 * scsizehud / 2) * h / 768,
              string.format("%3d", bestenemyscore),
              0.9 * scsizehud,
              nil,
              colord[1],
              colord[2],
  ...
  HUD.DrawQuadRGBA(
      nil,
      (1024 - markframe[3] - 80 * scsizehud / 2) * w / 1024,
      (768 - markframe[1] - 50 * scsizehud / 2) * h / 768,
      80 * scsizehud * w / 1024,
      3 * scsizehud * h / 768,
      cmarframe[1],
      cmarframe[2],
  ...
  HUD.DrawQuadRGBA(
      nil,
      (1024 - markframe[3] - 80 * scsizehud / 2) * w / 1024,
      (768 - markframe[1] + 47 * scsizehud - 50 * scsizehud / 2) * h / 768,
      80 * scsizehud * w / 1024,
      3 * scsizehud * h / 768,
      cmarframe[1],
      cmarframe[2],
  ...
  HUD.DrawQuadRGBA(
      nil,
      (1024 - markframe[3] - 80 * scsizehud / 2 + 77 * scsizehud) * w / 1024,
      (768 - markframe[1] - 50 * scsizehud / 2) * h / 768,
      3 * scsizehud * w / 1024,
      50 * scsizehud * h / 768,
      cmarframe[1],
  ...
  if spressthiskey == true then
      if Cfg.HUD_Scores_Frame == 1 then
          HUD.DrawQuadRGBA(
              nil,
              (1024 - scposxy1[3] - 80 * scsizehud / 2) * w / 1024,
              (768 - scposxy1[1] + 23.5 * scsizehud - 50 * scsizehud / 2) * h / 768,
              80 * scsizehud * w / 1024,
              3 * scsizehud * h / 768,
              0,
              255,
          ...
          HUD.DrawQuadRGBA(
              nil,
              (1024 - scposxy1[3] - 80 * scsizehud / 2 + 38.5 * scsizehud) * w / 1024,
              (768 - scposxy1[1] - 50 * scsizehud / 2) * h / 768,
              3 * scsizehud * w / 1024,
              50 * scsizehud * h / 768,
              0,
      ...
      elseif Cfg.HUD_Scores_Frame == 2 then
          HUD.DrawQuadRGBA(
              nil,
              (1024 - scposxy2[3] - 80 * scsizehud / 2) * w / 1024,
              (768 - scposxy2[1] + 23.5 * scsizehud - 50 * scsizehud / 2) * h / 768,
              80 * scsizehud * w / 1024,
              3 * scsizehud * h / 768,
              0,
              255,
          ...
          HUD.DrawQuadRGBA(
              nil,
              (1024 - scposxy2[3] - 80 * scsizehud / 2 + 38.5 * scsizehud) * w / 1024,
              (768 - scposxy2[1] - 50 * scsizehud / 2) * h / 768,
              3 * scsizehud * w / 1024,
              50 * scsizehud * h / 768,
              0,
  ...
  if spressthiskey == true then
      ...
      if Cfg.HUD_Scores_Frame == 1 then
          HUD.PrintXY(
              (w - HUD.GetTextWidth(alliedteam .. string.format(" Size: %02d", scsizehud * 100) .. "%")) / 2,
              h / 2.6,
              alliedteam .. string.format(" Size: %02d", scsizehud * 100) .. "%",
              "courbd",
              0,
              255,
              0,
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Vertical Position: %01d px", scposxy1[1] * h / 768))) / 2,
              h / 2.6 + HUD.GetTextHeight(),
              string.format("Vertical Position: %01d px", scposxy1[1] * h / 768),
              "courbd",
              0,
              255,
              0,
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Horinzontal Position: %01d px", scposxy1[3] * w / 1024))) / 2,
              h / 2.6 + HUD.GetTextHeight() * 2,
              string.format("Horinzontal Position: %01d px", scposxy1[3] * w / 1024),
              "courbd",
              0,
              255,
              0,
      ...
      elseif Cfg.HUD_Scores_Frame == 2 then
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Vertical Position: %01d px", scposxy2[1] * h / 768))) / 2,
              h / 2.6 + HUD.GetTextHeight(),
              string.format("Vertical Position: %01d px", scposxy2[1] * h / 768),
              "courbd",
              0,
              255,
              0,
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Horinzontal Position: %01d px", scposxy2[3] * w / 1024))) / 2,
              h / 2.6 + HUD.GetTextHeight() * 2,
              string.format("Horinzontal Position: %01d px", scposxy2[3] * w / 1024),
              "courbd",
              0,
              255,
              0,
  ...
  if nameshow ~= -1 then
      ...
      if Game.PlayerStats[nameshow].Team == Player.Team and MPGameRules[MPCfg.GameMode].Teams then
          ...
          if Cfg.CrosshairNamesT ~= "None" then
              ...
              HUD.PrintXY(
                  (w - HUD.GetTextWidth(HUD.StripColorInfo(textna))) / 2 + 1,
                  h / 2 + txtposy * h / 768 + 1,
                  HUD.StripColorInfo(textna),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  (w - HUD.GetTextWidth(HUD.StripColorInfo(textna))) / 2,
                  h / 2 + txtposy * h / 768,
                  HUD.StripColorInfo(textna),
                  "Impact",
                  vsfontcolortxtcnt[1],
      ...
      elseif
          Game.PlayerStats[nameshow].Team ~= Player.Team or
              MPCfg.GameMode ~= "Team Deathmatch" and MPCfg.GameMode ~= "Capture The Flag" and
                  MPCfg.GameMode ~= "Clan Arena"
       then
...
function Hud:DrawTeamOverlay()
  ...
  HUD.PrintXY(
      w * overlaypanel.x + w * panelfraction.name * overlaypanel.w,
      h * overlaypanel.y + vspace + 2,
      "Name",
      font,
      255,
      255,
  ...
  HUD.PrintXY(
      w * overlaypanel.x + w * panelfraction.location * overlaypanel.w,
      h * overlaypanel.y + vspace + 2,
      "Location",
      font,
      255,
  ...
  for i, ps in Game.PlayerStats, nil do
      if ps.Spectator == 0 and Game:IsTeammate(ps.ClientID) then
          ...
          HUD.PrintXY(
              w * overlaypanel.x + w * panelfraction.status * overlaypanel.w,
              h * overlaypanel.y + delta + 2,
              playerstate,
              font,
              255,
              255,
  ...
  for i, o in Game.Players, nil do
      if o.ClientID == 6 then
          ...
          HUD.PrintXY(
              100,
              110,
              "ForwardVector : " .. o.ForwardVector.X .. " " .. o.ForwardVector.Y .. " " .. o.ForwardVector.Z .. " ",
              font,
              255,
              255,
              255,
          ...
          HUD.PrintXY(
              100,
              120,
              "cplayer vels : " .. o._velocityz .. " " .. o._velocityz .. " " .. o._velocityz .. " " .. o._yaw,
              font,
              255,
              255,
              255,
          ...
          HUD.PrintXY(
              ...
              140,
              "ACTION : ON FLOOR " ..
                  tostring(INP.GetActionStatus(Game.PlayerStats[7]._Entity)) .. " " .. tostring(Game.bot[7].state),
              font,
              255,
              255,
              255,
          ...
          HUD.PrintXY(
              100,
              150,
              "cfdsfdsfdsls : " .. o._velocityz .. " " .. o._velocityz .. " " .. o._velocityz .. " " .. o._yaw,
              font,
              255,
              255,
              255,
...
function Hud:DrawQuickOptionsMenu()
  ...
  if
      (INP.Key(Keys.PgUp) == 2 or INP.Key(Keys.Insert) == 2 or INP.Key(Keys.Home) == 2 or
          INP.Key(Keys.NumDecimal) == 2) and
          self._DrawQuickOptions
   then
  ...
  if self._DrawQuickOptions == true then
      ...
      if
          INP.Key(FKeys[Cfg.KeyPrimaryQuickMenuValidate]) == 1 or
              INP.Key(FKeys[Cfg.KeyAlternativeQuickMenuValidate]) == 1
       then
          if self.SubMenuAOpen == true and self.SubMenuBOpen == false then
              if self._DrawQuickOptionsMenu == menu[1] then
                  if textsubma[self._SubMenuABright] == "Save your Hud" then
                      PMENU.ShowMenu()
                      PMENU.PauseSounds()
                      PainMenu:AskForFavoriteHudName(
                          "Type Name for the favorite.",
                          "PainMenu:AddFavoriteHud()",
                          "PainMenu:ActivateScreen(FavoriteHud); PainMenu:CheckItems()"
                      )
                      self._DrawQuickOptions = false
                  else
      ...
      for fa = 1, table.getn(menu) do
          if fa == table.getn(menu) then
              HUD.DrawQuadRGBA(
                  nil,
                  (w - 190 * w / 1024 - self.fasizew - self.fasizeaw) / 2,
                  mposh,
                  190 * w / 1024,
                  quadsize + qmax,
                  0,
      ...
      for ai = 1, table.getn(menu) do
          HUD.PrintXY(
              (w - 160 * w / 1024 - self.fasizew - self.fasizeaw) / 2,
              mposh + alt + textfrposth,
              menu[ai],
              "Impact",
              255,
              255,
          ...
          if self._DrawQuickOptionsMenu == menu[ai] then
              ...
              HUD.DrawQuadRGBA(
                  nil,
                  (w - (bsize * w / 1024 + self.fasizew + self.fasizeaw)) / 2,
                  mposh + alb + textfrposth,
                  bsize * w / 1024,
                  22 * h / 768,
                  0,
                  0,
      ...
      if self.SubMenuAOpen == true then
          ...
          for fb = 1, table.getn(textsubma) do
              if fb == table.getn(textsubma) then
                  HUD.DrawQuadRGBA(
                      nil,
                      (w + (178 * w / 1024 - self.fasizew - self.fasizeaw)) / 2,
                      centersubmenua,
                      self.fasizew,
                      quadsizea + qmax,
                      255,
          ...
          for bi = 1, table.getn(textsubma) do
              HUD.PrintXY(
                  (w + (208 * w / 1024 - self.fasizew - self.fasizeaw)) / 2,
                  centersubmenua + alt + textfbposth,
                  textsubma[bi],
                  "Impact",
                  255,
                  255,
              ...
              if self._DrawQuickOptionsMenu == "CallVote" then
                  Hud:QuadTrans(
                      self._matArrowMenu,
                      (w + 425 * w / 1024 - self.fasizew - self.fasizeaw) / 2,
                      centersubmenua + alt + textfbposth,
                      0.38,
                      false,
                      255
              ...
              if self._DrawQuickOptionsSubMenuA == textsubma[bi] then
                  HUD.DrawQuadRGBA(
                      nil,
                      (w + (184 * w / 1024 - self.fasizew - self.fasizeaw)) / 2,
                      centersubmenua + alb + textfbposth,
                      self.fasizew - 6 * w / 1024,
                      22 * h / 768,
                      0,
                      0,
                      255,
      ...
      if self.SubMenuBOpen == true then
          ...
          for fc = 1, table.getn(textsubmb) do
              if fc == table.getn(textsubmb) then
                  HUD.DrawQuadRGBA(
                      nil,
                      (w + (443 * w / 1024 - self.fasizeaw - self.fasizew)) / 2,
                      centersubmenub,
                      self.fasizeaw,
                      quadsizeb + qmax,
                      255,
          ...
          for bi = 1, table.getn(textsubmb) do
              ...
              HUD.PrintXY(
                  (w + (470 * w / 1024 - self.fasizeaw - self.fasizew)) / 2,
                  centersubmenub + alt + textfyposth,
                  txt,
                  "Impact",
                  255,
                  255,
              ...
              if self._DrawQuickOptionsSubMenuB == textsubmb[bi] then
                  HUD.DrawQuadRGBA(
                      nil,
                      (w + (449 * w / 1024 - self.fasizew - self.fasizeaw)) / 2,
                      centersubmenub + alb + textfyposth,
                      self.fasizeaw - 6 * w / 1024,
                      22 * h / 768,
                      0,
                      0,
                      255,
...
function Hud:StatsText(statsplayer)
  ...
  if Game.Stats[statsplayer] ~= nil then
      ...
      HUD.DrawQuadRGBA(nil, 0, 0, w, h, 0, 0, 0, 200)
      local twa =
          HUD.GetTextWidth(tat) + HUD.GetTextWidth(tht) + HUD.GetTextWidth(tsh) + HUD.GetTextWidth(tda) +
          HUD.GetTextWidth(tef)
      local txta = "Weapon Statistics for " .. Game.PlayerStats[statsplayer].Name
      local twb = HUD.GetTextWidth(txta)
      HUD.DrawQuadRGBA(
          nil,
          w / 2 - twa / 2,
          h / 2 - HUD.GetTextHeight() * 3.4 - center,
          twa,
          HUD.GetTextHeight() * 1.6,
          50,
          50,
          50,
          120
      ...
      HUD.DrawQuadRGBA(
          nil,
          w / 2 - twa / 2 + twad,
          h / 2 - HUD.GetTextHeight() * 1.5 - center,
          HUD.GetTextWidth(tht),
          HUD.GetTextHeight() * 1.3,
          50,
          50,
          50,
          120
      ...
      HUD.DrawQuadRGBA(
          nil,
          w / 2 - twa / 2 + twad + twaa + twab,
          h / 2 - HUD.GetTextHeight() * 1.5 - center,
          HUD.GetTextWidth(tda),
          HUD.GetTextHeight() * 1.3,
          50,
          50,
          50,
      ...
      HUD.PrintXY(
          w / 2 - twa / 2 + twad,
          h / 2 - HUD.GetTextHeight() * 1.3 - center,
          tht,
          "courbd",
          225,
          255,
                  ...
                  "   " ..
                      attack_type.hits ..
                          hitspace ..
                              attack_type.shots ..
                                  shotspace ..
                                      math.floor(attack_type.damage) ..
                                          damagepace .. string.format("%02d", percentage) .. "%"
      ...
      HUD.PrintXY(
          w / 2 - twa / 2,
          h / 2 + HUD.GetTextHeight() * 0.25 + Hud.StatsPos - center,
          txt,
          "courbd",
          225,
          255,
