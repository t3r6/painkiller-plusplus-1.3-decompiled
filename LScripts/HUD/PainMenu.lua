...
function PainMenu:AddItem(i, o)
  ...
  if IsMPDemo() then
      ...
      elseif itemName == "Quit" then
          o.action =
              "PainMenu:AskYesNo( Languages.Texts[469], 'PainMenu:ActivateScreen(DemoEnd)', 'PainMenu:ActivateScreen(MainMenu)' )"
  ...
  if skip == false then
      ...
      elseif o.type == MenuItemTypes.TextButtonEx then
          ...
          for i, v in o.values, nil do
              if
                  (itemName ~= "ModelSelect" or i <= table.getn(o.values) or Game.BonusMPModel or Game.BonusMPModel2 or
                      IsMPDemo()) and
                      v == Cfg[o.option]
               then
                  o.currValue = i
...
function PainMenu:AddControlConfig(item)
  ...
  while i do
      ...
      PMENU.AddKeyControl(
          ...
          o[2],
          o[3],
          INP.GetKeyNameByEngName(Cfg[o[2]]),
          INP.GetKeyNameByEngName(Cfg[o[3]]),
          Cfg[o[2]],
          Cfg[o[3]]
      )
...
function PainMenu:AddSimpleKeyConf(name, item)
  PMENU.AddSimpleKeyConf(
      name,
      INP.GetKeyNameByEngName(Cfg[item.option][item.index]),
      Cfg[item.option][item.index],
      item.index
  )
end
...
function PainMenu:ReloadSaveGameList(name, sort)
  ...
  if
      type ~= "Auto" and Game.GameInProgress == true and Game.Difficulty < 3 and Game.GMode == GModes.SingleGame and
          (not Player or Player.Health > 0)
   then
...
function PainMenu:AfterControlChange(name)
  ...
  elseif self.currScreen == PlayerOptions and name == "NewPrediction" then
      ...
      if Game.GMode ~= GModes.SingleGame and not Game:IsServer() then
          PainMenu:ShowInfo(
              Languages.Texts[748],
              "PainMenu:ApplySettings(); PainMenu:ActivateScreen(PlayerOptions)",
              26,
              "PredictionWarning",
              Languages.Texts[470]
          )
...
function PainMenu:ApplyVideoSettings()
  ...
  if Lev ~= nil then
      ...
      WORLD.SetupFog(
          mode,
          f.Start * (Cfg.ClipPlane + 100) / 200,
          f.End * (Cfg.ClipPlane + 100) / 200,
          f.Density,
          f.Color:Compose()
      )
  end
...
function PainMenu:JoinServer(public, spectator)
  ...
  local res =
      PMENU.JoinServer(self.playerName, self.passwd, self.speed, self.host, self.port, self.public, self.spectator)
  if res == false then
...
function PainMenu:SignAPact(mode, addon)
  ...
  if not mode or mode == 1 then
      if Game.GameInProgress then
          PainMenu:AskYesNo(
              Languages.Texts[686],
              "Game.GameInProgress = false; Game.LevelStarted = false; Game:ClearLevelsStats(false); PainMenu:SignAPact(2," ..
                  add .. ")",
              "PainMenu:ActivateScreen(GameMenu)"
          )
      else
      ...
      if
          not ask and Levels[1][1] and Game.LevelsStats[Levels[1][1][1]] and
              Game.LevelsStats[Levels[1][1][1]].Finished == true
       then
          ask = true
      end
      ...
      if ask then
          PainMenu:AskYesNo(
              ...
              "Game.AddOn = " ..
                  add ..
                      "; Game.GameInProgress = false; Game.LevelStarted = false; if Game then Game.AddOn = " ..
                          add .. "; Game:ClearLevelsStats(true) end; PainMenu:ActivateScreen(NewGameMenu)",
              "Game.AddOn = " ..
                  add ..
                      "; Game.GameInProgress = false; Game.LevelStarted = false; PainMenu:ActivateScreen(NewGameMenu)"
          )
      else
          Game.GameInProgress = false
          Game.LevelStarted = false
...
function PainMenu:SignAPactBooHOnly(mode, addon)
  ...
  if not mode or mode == 1 then
      if Game.GameInProgress then
          PainMenu:AskYesNo(
              Languages.Texts[686],
              "Game.GameInProgress = false; Game.LevelStarted = false; Game:ClearLevelsStats(false); PainMenu:SignAPactBooHOnly(2," ..
                  add .. ")",
              "PainMenu:ActivateScreen(MainMenu)"
          )
      else
...
function PainMenu:SignAPactPKOnly(mode, addon)
  ...
  if not mode or mode == 1 then
      if Game.GameInProgress then
          PainMenu:AskYesNo(
              Languages.Texts[686],
              "Game.GameInProgress = false; Game.LevelStarted = false; Game:ClearLevelsStats(false); PainMenu:SignAPactPKOnly(2," ..
                  add .. ")",
              "PainMenu:ActivateScreen(MainMenu)"
          )
      else
...
function PainMenu:AskReturnToMap()
  if not Game.LevelStarted then
      ...
      PainMenu:AskYesNo(
          Languages.Texts[687],
          "Game.LevelStarted = false; PMENU.SwitchToMap()",
          "PainMenu:ActivateScreen(MainMenu)"
      )
  end
end
...
function PainMenu:NeedRestartGame(screen)
  PainMenu:AskYesNo(
      "Need restart game. Click yes to exit game.",
      "Exit()",
      "PainMenu:ActivateScreen(" .. screen .. "); PainMenu:CheckItems()"
  )
end
...
function PainMenu:NeedReconnection(cfgarg)
  if Game.LevelStarted == true then
      PainMenu:AskYesNo(
          Languages.Texts[748],
          "PainMenu:CfgModif(" .. cfgarg .. ")",
          "PMENU.ResumeSounds(); PMENU.ReturnToGame(); PainMenu:ReloadBrightskins()"
      )
  end
end
      ...
      if check[i] == true then
          ...
          if not fexist then
              ...
              if defaultfile[i] == "Normal_HUD.cfg" then
                  f:write(
                      "--[WARNING: Do NOT edit this file. Can not be deleted.]" ..
                          [[
                              ...
                              "function PainMenu:SetRefValues()" ..
                                  "\n" ..
                                      "\tref.SaveName = " ..
                                          string.format("%q", cfgdefvalue[1]) ..
                                              "\n" ..
                                                  "\tref.Style = " ..
                                                      string.format("%q", cfgdefvalue[2]) ..
                                                          "\n" ..
                                                              "\tref.Date = " ..
                                                                  string.format("%q", cfgdefvalue[3]) ..
                                                                      "\n" ..
                                                                          "\tref.Time = " ..
                                                                              string.format("%q", cfgdefvalue[4]) ..
                                                                                  "\n" ..
                                                                                      "\tref.Sort = " ..
                                                                                          string.format(
                                                                                              "%q",
...
function PainMenu:AddFavoriteHud()
  ...
  f:write(
      "--[WARNING: Do NOT edit this file. Can be deleted.]" ..
          [[
              ...
              "function PainMenu:SetRefValues()" ..
                  "\n" ..
                      "\tref.SaveName = " ..
                          string.format("%q", cfgvalue[1]) ..
                              "\n" ..
                                  "\tref.Style = " ..
                                      string.format("%q", cfgvalue[2]) ..
                                          "\n" ..
                                              "\tref.Date = " ..
                                                  string.format("%q", cfgvalue[3]) ..
                                                      "\n" ..
                                                          "\tref.Time = " ..
                                                              string.format("%q", cfgvalue[4]) ..
                                                                  "\n" ..
                                                                      "\tref.Sort = " ..
                                                                          string.format("%q", cfgvalue[5]) ..
                                                                              "\n" ..
                                                                                  "\tref.Anim = " ..
                                                                                      string.format("%q", cfgvalue[6]) ..
                                                                                          "\n" ..
                                                                                              "end" ..
                                                                                                  [[
  ...
  for i, v in sorted, nil do
      if
          string.sub(v[1], 1, 1) ~= "_" and
              (type(v[2]) == "string" or type(v[2]) == "number" or type(v[2]) == "boolean")
       then
          local val = v[2]
