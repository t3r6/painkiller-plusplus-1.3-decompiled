  ...
  if Player then
      if 0 < checkposx then
          ...
          if Cfg.HUD_Show_Speedmeter == 2 or Cfg.HUD_Show_Speedmeter == 3 then
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(ups) + (posx * w / 1024 + 1),
                  vara + (posy + 1) * h / 768,
                  ups,
                  spfonttypo,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(ups) + posx * w / 1024,
                  vara + posy * h / 768,
                  ups,
                  spfonttypo,
                  spfontcolortxt[1],
              ...
              HUD.DrawQuadRGBA(
                  nil,
                  w / 2 - hll * (hll / 10.5) * w / 1024 + posx * w / 1024,
                  varb + (posy + 1) * h / 768,
                  hll * (hll / 10.5) * w / 1024,
                  3 * h / 768,
                  colorfont[1],
          ...
          if spressthiskey == true and Cfg.HUD_Infos_Items == 4 then
              if Cfg.HUD_Show_Speedmeter == 2 or Cfg.HUD_Show_Speedmeter == 3 then
                  ...
                  HUD.DrawQuadRGBA(
                      nil,
                      w / 2 - HUD.GetTextWidth(ups) + posx * w / 1024,
                      infoitems[2] * h / 768 + showpossmeter + HUD.GetTextHeight() / 2 - 3 * h / 768,
                      HUD.GetTextWidth(ups),
                      3 * h / 768,
                      0,
                      255,
                  ...
                  HUD.DrawQuadRGBA(
                      nil,
                      w / 2 - (HUD.GetTextWidth(ups) - HUD.GetTextWidth(ups) / 2) + posx * w / 1024,
                      infoitems[2] * h / 768 - 1.5 * h / 768 + showpossmeter,
                      3 * w / 1024,
                      HUD.GetTextHeight(),
                      0,
                      255,
                  ...
                  HUD.DrawQuadRGBA(
                      nil,
                      w / 2 - HUD.GetTextWidth("0.0 Ups") + posx * w / 1024,
                      vara + (posy + 1) * h / 768,
                      HUD.GetTextWidth("0.0 Ups"),
                      10 * h / 768,
                      0,
                      255,
                      0
          ...
          if Cfg.HUD_Show_Speedmeter == 2 or Cfg.HUD_Show_Speedmeter == 3 then
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth("0.0 Ups") + (posx * w / 1024 + 1),
                  vara + (posy + 1) * h / 768,
                  ups,
                  spfonttypo,
                  15,
          ...
          if spressthiskey == true and Cfg.HUD_Infos_Items == 4 then
              if Cfg.HUD_Show_Speedmeter == 2 or Cfg.HUD_Show_Speedmeter == 3 then
                  ...
                  HUD.DrawQuadRGBA(
                      nil,
                      w / 2 - (HUD.GetTextWidth("0.0 Ups") - HUD.GetTextWidth(ups) / 2) + posx * w / 1024,
                      infoitems[2] * h / 768 - 1.5 * h / 768 + showpossmeter,
                      3 * w / 1024,
                      HUD.GetTextHeight(),
                      0,
      ...
      HUD.SetFont(spfonttypo, spfontsizes)
      HUD.PrintXY(
          w / 2 - HUD.GetTextWidth(ups) + (508 * w / 1024 + 1),
          specrealpos + 5 * h / 768 + 1,
          ups,
          spfonttypo,
          15,
          15,
      ...
      HUD.PrintXY(
          w / 2 - HUD.GetTextWidth(ups) + 508 * w / 1024,
          specrealpos + 4 * h / 768,
          ups,
          spfonttypo,
          spfontcolortxt[1],
      ...
      HUD.DrawQuadRGBA(
          nil,
          w / 2 - HUD.GetTextWidth(ups) + 508 * w / 1024,
          specrealpos + HUD.GetTextHeight() + 5 * h / 768,
          hll * 1.6 * w / 1024,
          3 * h / 768,
          colorfont[1],
          colorfont[2],
...
function Hud:DrawInfosTimerBegins()
      ...
      if Cfg.ShowFPS or Cfg.HUD_Show_FPS then
          ...
          if Player then
              if 0 < checkposx then
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth(fps) + (posx * w / 1024 + 1),
                      posy * h / 768 + 1,
                      fps,
                      fonttypo,
                      15,
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth(fps) + posx * w / 1024,
                      posy * h / 768,
                      fps,
                      fonttypo,
                      fontcolortxt[1],
                  ...
                  if spressthiskey == true and Cfg.HUD_Infos_Items == 1 then
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - HUD.GetTextWidth(fps) + posx * w / 1024,
                          posy * h / 768 + HUD.GetTextHeight() / 2 - 3 * h / 768,
                          HUD.GetTextWidth(fps),
                          3 * h / 768,
                          0,
                          255,
                          0,
                      ...
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - (HUD.GetTextWidth(fps) - HUD.GetTextWidth(fps) / 2) + posx * w / 1024,
                          (posy - 1.5) * h / 768,
                          3 * w / 1024,
                          HUD.GetTextHeight(fps),
                          0,
                          255,
                          0,
                          255
                  ...
                  HUD.SetFont(fonttypo, fontsizes[1])
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth("000 FPS") + (posx * w / 1024 + 1),
                      posy * h / 768 + 1,
                      fps,
                      fonttypo,
                      15,
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth("000 FPS") + posx * w / 1024,
                      posy * h / 768,
                      fps,
                      fonttypo,
                      fontcolortxt[1],
                  ...
                  if spressthiskey == true and Cfg.HUD_Infos_Items == 1 then
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - HUD.GetTextWidth("000 FPS") + posx * w / 1024,
                          posy * h / 768 + HUD.GetTextHeight(fps) / 2 - 3 * h / 768,
                          HUD.GetTextWidth(fps),
                          3 * h / 768,
                          0,
                          255,
                      ...
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - (HUD.GetTextWidth("000 FPS") - HUD.GetTextWidth(fps) / 2) + posx * w / 1024,
                          (posy - 1.5) * h / 768,
                          3 * w / 1024,
                          HUD.GetTextHeight(fps),
                          0,
              ...
              HUD.SetFont(fonttypo, fontsizes[1])
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(fps) + (508 * w / 1024 + 1),
                  5 * h / 768 + 1,
                  fps,
                  fonttypo,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(fps) + 508 * w / 1024,
                  4 * h / 768,
                  fps,
                  fonttypo,
                  fontcolortxt[1],
      ...
      if Cfg.HUD_Show_PacketLoss then
          ...
          if Player then
              if 0 < checkposx then
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth(ploss) + (posx * w / 1024 + 1),
                      realpos + (posy * h / 768 + 1),
                      ploss,
                      fonttypo,
                      15,
                      15,
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth(ploss) + posx * w / 1024,
                      realpos + posy * h / 768,
                      ploss,
                      fonttypo,
                      fontcolortxt[1],
                  ...
                  if spressthiskey == true and Cfg.HUD_Infos_Items == 2 then
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - HUD.GetTextWidth(ploss) + posx * w / 1024,
                          posy * h / 768 + showpospl + HUD.GetTextHeight() / 2 - 3 * h / 768,
                          HUD.GetTextWidth(ploss),
                          3 * h / 768,
                          0,
                          255,
                          0,
                      ...
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - (HUD.GetTextWidth(ploss) - HUD.GetTextWidth(ploss) / 2) + posx * w / 1024,
                          (posy - 1.5) * h / 768 + showpospl,
                          3 * w / 1024,
                          HUD.GetTextHeight(),
                          0,
                          255,
                  ...
                  HUD.SetFont(fonttypo, fontsizes[2])
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth("0 PL") + (posx * w / 1024 + 1),
                      realpos + (posy * h / 768 + 1),
                      ploss,
                      fonttypo,
                      15,
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth("0 PL") + posx * w / 1024,
                      realpos + posy * h / 768,
                      ploss,
                      fonttypo,
                      fontcolortxt[1],
                  ...
                  if spressthiskey == true and Cfg.HUD_Infos_Items == 2 then
                      ...
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - (HUD.GetTextWidth("0 PL") - HUD.GetTextWidth(ploss) / 2) + posx * w / 1024,
                          (posy - 1.5) * h / 768 + showpospl,
                          3 * w / 1024,
                          HUD.GetTextHeight(),
                          0,
              ...
              HUD.SetFont(fonttypo, fontsizes[1])
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(ploss) + (508 * w / 1024 + 1),
                  specrealpos + 5 * h / 768 + 1,
                  ploss,
                  fonttypo,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(ploss) + 508 * w / 1024,
                  specrealpos + 4 * h / 768,
                  ploss,
                  fonttypo,
                  fontcolortxt[1],
      ...
      if Cfg.HUD_Show_Ping then
          ...
          if Player then
              if 0 < checkposx then
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth(ping) + (posx * w / 1024 + 1),
                      realpos + (posy * h / 768 + 1),
                      ping,
                      fonttypo,
                      15,
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth(ping) + posx * w / 1024,
                      realpos + posy * h / 768,
                      ping,
                      fonttypo,
                      pingcolor[1],
                  ...
                  if spressthiskey == true and Cfg.HUD_Infos_Items == 3 then
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - HUD.GetTextWidth(ping) + posx * w / 1024,
                          posy * h / 768 + showposping + HUD.GetTextHeight() / 2 - 3 * h / 768,
                          HUD.GetTextWidth(ping),
                          3 * h / 768,
                          0,
                          255,
                          0,
                      ...
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - (HUD.GetTextWidth(ping) - HUD.GetTextWidth(ping) / 2) + posx * w / 1024,
                          (posy - 1.5) * h / 768 + showposping,
                          3 * w / 1024,
                          HUD.GetTextHeight(),
                          0,
                          255,
                  ...
                  HUD.SetFont(fonttypo, fontsizes[3])
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth("00 ms") + (posx * w / 1024 + 1),
                      realpos + (posy * h / 768 + 1),
                      ping,
                      fonttypo,
                      15,
                  ...
                  HUD.PrintXY(
                      w / 2 - HUD.GetTextWidth("00 ms") + posx * w / 1024,
                      realpos + posy * h / 768,
                      ping,
                      fonttypo,
                      pingcolor[1],
                  ...
                  if spressthiskey == true and Cfg.HUD_Infos_Items == 3 then
                      ...
                      HUD.DrawQuadRGBA(
                          nil,
                          w / 2 - (HUD.GetTextWidth("00 ms") - HUD.GetTextWidth(ping) / 2) + posx * w / 1024,
                          (posy - 1.5) * h / 768 + showposping,
                          3 * w / 1024,
                          HUD.GetTextHeight(),
                          0,
              ...
              HUD.SetFont(fonttypo, fontsizes[1])
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(ping) + (508 * w / 1024 + 1),
                  specrealpos + 5 * h / 768 + 1,
                  ping,
                  fonttypo,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 - HUD.GetTextWidth(ping) + 508 * w / 1024,
                  specrealpos + 4 * h / 768,
                  ping,
                  fonttypo,
                  pingcolor[1],
      ...
      if Cfg.ShowTimer ~= false then
          if Player then
              ...
              if (self._showtimer or Cfg.ShowTimer) and Game.GMode ~= GModes.SingleGame then
                  HUD.PrintXY(
                      (w - HUD.GetTextWidth(time)) / 2 + posw + 1,
                      posh + 1,
                      time,
                      fonttypo,
                      15,
                  ...
                  if red then
                      HUD.PrintXY(
                          (w - HUD.GetTextWidth(time)) / 2 + posw,
                          posh,
                          time,
                          fonttypo,
                          230,
              ...
              if spressthiskey == true and Cfg.HUD_Infos_Items == 5 then
                  HUD.DrawQuadRGBA(
                      nil,
                      (w - HUD.GetTextWidth(time)) / 2 + posw,
                      posh + (fontsizes[5] - fontsizes[5] / 3) * h / 768 / 2,
                      HUD.GetTextWidth(time),
                      3 * h / 768,
                      0,
                      255,
                      0,
                  ...
                  HUD.DrawQuadRGBA(
                      nil,
                      (w - HUD.GetTextWidth(time)) / 2 + posw + (HUD.GetTextWidth(time) / 2 - 2),
                      posh,
                      3 * w / 1024,
                      HUD.GetTextHeight(time) - fontsizes[5] / 4.5 * h / 768,
                      0,
                      255,
                      0,
                      255
  ...
  if Cfg.HUD_FragMessage_Status then
      ...
      if 0 < checkposx then
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[1] or spressthiskey then
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[1]) - HUD.GetTextWidth(dname[1]) -
                      sizex * varsize * w / 1024 +
                      1,
                  (posy + itemsposh[1]) * h / 768 + 1,
                  HUD.StripColorInfo(kname[1]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              Hud:QuadRGBA(
                  attacktype[at[1]],
                  w / 2 + posx * w / 1024 - sizex * varsize * w / 1024 - HUD.GetTextWidth(dname[1]),
                  (posy - 2 + itemsposh[1]) * h / 768,
                  varsize,
                  false,
                  color[at[1]].R,
                  color[at[1]].G,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[1]) + 1,
                  (posy + itemsposh[1]) * h / 768 + 1,
                  HUD.StripColorInfo(dname[1]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[1]),
                  (posy + itemsposh[1]) * h / 768,
                  dname[1],
                  "Impact",
                  255,
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[2] or spressthiskey then
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[2]) - HUD.GetTextWidth(dname[2]) -
                      sizex * varsize * w / 1024 +
                      1,
                  (posy + itemsposh[2] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(kname[2]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[2]) - HUD.GetTextWidth(dname[2]) -
                      sizex * varsize * w / 1024,
                  (posy + itemsposh[2] * varsize) * h / 768,
                  kname[2],
                  "Impact",
                  255,
                  255,
              ...
              Hud:QuadRGBA(
                  attacktype[at[2]],
                  w / 2 + posx * w / 1024 - sizex * varsize * w / 1024 - HUD.GetTextWidth(dname[2]),
                  (posy - 2 + itemsposh[2] * varsize) * h / 768,
                  varsize,
                  false,
                  color[at[2]].R,
                  color[at[2]].G,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[2]) + 1,
                  (posy + itemsposh[2] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(dname[2]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[2]),
                  (posy + itemsposh[2] * varsize) * h / 768,
                  dname[2],
                  "Impact",
                  255,
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[3] or spressthiskey then
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[3]) - HUD.GetTextWidth(dname[3]) -
                      sizex * varsize * w / 1024 +
                      1,
                  (posy + itemsposh[3] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(kname[3]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[3]) - HUD.GetTextWidth(dname[3]) -
                      sizex * varsize * w / 1024,
                  (posy + itemsposh[3] * varsize) * h / 768,
                  kname[3],
                  "Impact",
                  255,
                  255,
              ...
              Hud:QuadRGBA(
                  attacktype[at[3]],
                  w / 2 + posx * w / 1024 - sizex * varsize * w / 1024 - HUD.GetTextWidth(dname[3]),
                  (posy - 2 + itemsposh[3] * varsize) * h / 768,
                  varsize,
                  false,
                  color[at[3]].R,
                  color[at[3]].G,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[3]) + 1,
                  (posy + itemsposh[3] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(dname[3]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[3]),
                  (posy + itemsposh[3] * varsize) * h / 768,
                  dname[3],
                  "Impact",
                  255,
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[4] or spressthiskey then
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[4]) - HUD.GetTextWidth(dname[4]) -
                      sizex * varsize * w / 1024 +
                      1,
                  (posy + itemsposh[4] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(kname[4]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[4]) - HUD.GetTextWidth(dname[4]) -
                      sizex * varsize * w / 1024,
                  (posy + itemsposh[4] * varsize) * h / 768,
                  kname[4],
                  "Impact",
                  255,
                  255,
              ...
              Hud:QuadRGBA(
                  attacktype[at[4]],
                  w / 2 + posx * w / 1024 - sizex * varsize * w / 1024 - HUD.GetTextWidth(dname[4]),
                  (posy - 2 + itemsposh[4] * varsize) * h / 768,
                  varsize,
                  false,
                  color[at[4]].R,
                  color[at[4]].G,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[4]) + 1,
                  (posy + itemsposh[4] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(dname[4]),
                  "Impact",
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(dname[4]),
                  (posy + itemsposh[4] * varsize) * h / 768,
                  dname[4],
                  "Impact",
                  255,
          ...
          if spressthiskey == true and Cfg.HUD_Infos_Items == 6 then
              HUD.DrawQuadRGBA(
                  ...
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[1]) - HUD.GetTextWidth(dname[1]) -
                      sizex * varsize * w / 1024,
                  posy * h / 768 + HUD.GetTextHeight() / 2 - 3,
                  HUD.GetTextWidth(kname[1]) + HUD.GetTextWidth(dname[1]) + sizex * varsize * w / 1024,
                  3 * h / 768,
                  0,
                  255,
                  0,
              ...
              HUD.DrawQuadRGBA(
                  nil,
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth(kname[1]) - sizex * varsize * w / 1024 / 2 - 1.5,
                  posy * h / 768,
                  3 * w / 1024,
                  HUD.GetTextHeight(),
                  0,
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[1] or spressthiskey then
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 - sizex * varsize * w / 1024 + 1,
                  (posy + itemsposh[1]) * h / 768 + 1,
                  HUD.StripColorInfo(kname[1]),
                  "Impact",
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 - sizex * varsize * w / 1024,
                  (posy + itemsposh[1]) * h / 768,
                  kname[1],
                  "Impact",
                  255,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[1]) + 1,
                  (posy + itemsposh[1]) * h / 768 + 1,
                  HUD.StripColorInfo(dname[1]),
                  "Impact",
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[1]),
                  (posy + itemsposh[1]) * h / 768,
                  dname[1],
                  "Impact",
                  255,
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[2] or spressthiskey then
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[2]) + 1,
                  (posy + itemsposh[2] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(dname[2]),
                  "Impact",
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[2]),
                  (posy + itemsposh[2] * varsize) * h / 768,
                  dname[2],
                  "Impact",
                  255,
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[3] or spressthiskey then
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[3]) + 1,
                  (posy + itemsposh[3] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(dname[3]),
                  "Impact",
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[3]),
                  (posy + itemsposh[3] * varsize) * h / 768,
                  dname[3],
                  "Impact",
                  255,
          ...
          if Game.currentTime * 2 < Hud.AttackTypeEnd[4] or spressthiskey then
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[4]) + 1,
                  (posy + itemsposh[4] * varsize) * h / 768 + 1,
                  HUD.StripColorInfo(dname[4]),
                  "Impact",
                  15,
              ...
              HUD.PrintXY(
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") * 2 + HUD.GetTextWidth(kname[4]),
                  (posy + itemsposh[4] * varsize) * h / 768,
                  dname[4],
                  "Impact",
                  255,
          ...
          if spressthiskey == true and Cfg.HUD_Infos_Items == 6 then
              ...
              HUD.DrawQuadRGBA(
                  nil,
                  w / 2 + posx * w / 1024 - HUD.GetTextWidth("Player") - sizex * varsize * w / 1024 / 2 - 1.5,
                  posy * h / 768,
                  3 * w / 1024,
                  HUD.GetTextHeight(),
                  0,
      ...
      if spressthiskey == true then
          ...
          if checkitem[v] == true then
              if 5 > Cfg.HUD_Infos_Items then
                  ...
                  if
                      INP.Key(Keys.Num8) == 3 or INP.Key(Keys.Num6) == 3 or INP.Key(Keys.Num4) == 3 or
                          INP.Key(Keys.Num2) == 3 or
                  ...
                  HUD.PrintXY(
                      (w - HUD.GetTextWidth(itemsname[v] .. " Font Size: " .. infoitems[v][3])) / 2,
                      h / 2.6,
                      itemsname[v] .. " Font Size: " .. infoitems[v][3],
                      "courbd",
                      0,
                      255,
                      0,
                  ...
                  HUD.PrintXY(
                      (w -
                          HUD.GetTextWidth(
                              string.format("Vertical Position: %.01f px", infoitems[v][2] * h / 768 + showpos[v])
                          )) /
                          2,
                  ...
                  HUD.PrintXY(
                      (w -
                          HUD.GetTextWidth(
                              string.format("Horinzontal Position: %.01f px", (infoitems[v][1] - fixposw) * w / 1024)
                          )) /
                          2,
              ...
              elseif Cfg.HUD_Infos_Items == 5 then
                  ...
                  HUD.PrintXY(
                      (w - HUD.GetTextWidth(string.format("Vertical Position: %.01f px", infoitems[v][2]))) / 2,
                      h / 2.6 + HUD.GetTextHeight(),
                      string.format("Vertical Position: %01d px", infoitems[v][2]),
                      "courbd",
                      0,
                      255,
                      0,
                  ...
                  HUD.PrintXY(
                      (w - HUD.GetTextWidth(string.format("Horinzontal Position: %.01f px", infoitems[v][1]))) / 2,
                      h / 2.6 + HUD.GetTextHeight() * 2,
                      string.format("Horinzontal Position: %01d px", infoitems[v][1]),
                      "courbd",
                      0,
                      255,
                      0,
              ...
              elseif Cfg.HUD_Infos_Items == 6 then
                  ...
                  HUD.PrintXY(
                      (w -
                          HUD.GetTextWidth(string.format("Horinzontal Position: %.01f px", infoitems[v][1] - poshfix))) /
                          2,
                      h / 2.6 + HUD.GetTextHeight() * 2,
                      string.format("Horinzontal Position: %01d px", infoitems[v][1] - poshfix),
                      "courbd",
                      0,
                      255,
                      0,
  ...
  if Game and MPCfg.GameState == GameStates.Counting and Game._countTimer and Game._countTimer > 0.99 then
      ...
      HUD.PrintXY(
          (w - HUD.GetTextWidth(countdown)) / 2,
          601 * h / 768,
          countdown,
          fonttypo,
          fontcolortxtb[1],
  ...
  if MPCfg.GameState == GameStates.WarmUp or MPCfg.GameState == GameStates.Counting then
      ...
      if check == "no" then
          if pl1 ~= "" and pl2 ~= "" then
              ...
              HUD.PrintXY(
                  (w - HUD.GetTextWidth("" .. HUD.StripColorInfo(pl1) .. "  -VS-  " .. HUD.StripColorInfo(pl2) .. "")) /
                      2 +
                      2,
                  200 * h / 768 + 2,
                  "" .. HUD.StripColorInfo(pl1) .. "  -VS-  " .. HUD.StripColorInfo(pl2) .. "",
                  vsfonttypo,
                  15,
                  15,
                  15,
              ...
              HUD.PrintXY(
                  (w - HUD.GetTextWidth("" .. pl1 .. "  -VS-  " .. pl2 .. "")) / 2,
                  200 * h / 768,
                  "" .. pl1 .. "  -VS-  " .. pl2 .. "",
                  vsfonttypo,
                  vsfontcolortxt[1],
...
function Hud:FragMessage(fname)
  ...
  HUD.PrintXY(
      (w - HUD.GetTextWidth("You killed: " .. HUD.StripColorInfo(fname) .. "!")) / 2 + 1,
      450 * h / 768 + 1,
      "You killed: " .. HUD.StripColorInfo(fname) .. "!",
      fafonttypo,
      15,
      15,
      15,
  ...
  HUD.PrintXY(
      (w - HUD.GetTextWidth("You killed: " .. fname .. "!")) / 2,
      450 * h / 768,
      "You killed: " .. fname .. "!",
      fafonttypo,
      fafontcolortxt[1],
