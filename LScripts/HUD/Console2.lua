...
function Console:Cmd_BRIGHTSKINTEAM(enable)
  ...
  CONSOLE_AddMessage(
      "Syntax: BrightskinTeam [Red/Green/Blue/Cyan/Magenta/Yellow/White/Black/Orange/Pink/Purple/Grey/Brown]"
  )
  ...
  if enable ~= nil then
      if Cfg.RconPass ~= nil then
          NET.SendVariable(
              NET.GetClientID(),
              "ref",
              tostring(NET.GetClientID()) .. "," .. Cfg.RconPass .. "," .. enable
          )
          return
      else
...
function Console:Cmd_CONSOLEPOSITION(val)
  ...
  if val == nil then
      CONSOLE_AddMessage(
          "Message position  (sets position for the messages console, defaut position 0 px, PK++ setting " ..
              565 * 768 / h .. " px)"
      )
  ...
  CONSOLE_AddMessage(
      "current color:  " ..
          Cfg.HUD_Ammolist_Marker_RGB[1] ..
              "," .. Cfg.HUD_Ammolist_Marker_RGB[2] .. "," .. Cfg.HUD_Ammolist_Marker_RGB[3]
  )
end
  ...
  CONSOLE_AddMessage(
      "current color:  " ..
          Cfg.HUD_Ammolist_Count_RGB[1] ..
              "," .. Cfg.HUD_Ammolist_Count_RGB[2] .. "," .. Cfg.HUD_Ammolist_Count_RGB[3]
  )
end
...
function Console:Cmd_HUD_COUNT_RGB(r, g, b)
  ...
  CONSOLE_AddMessage(
      "current color:  " .. Cfg.HUD_Count_RGB[1] .. "," .. Cfg.HUD_Count_RGB[2] .. "," .. Cfg.HUD_Count_RGB[3]
  )
end
...
function Console:Cmd_HUD_SCORES_COUNT_RGB(r, g, b)
  ...
  CONSOLE_AddMessage(
      "current color:  " ..
          Cfg.HUD_Scores_Count_RGB[1] .. "," .. Cfg.HUD_Scores_Count_RGB[2] .. "," .. Cfg.HUD_Scores_Count_RGB[3]
  )
end
...
function Console:Cmd_TEAMMATEICON_RGB(enable, r, g, b)
  ...
  CONSOLE_AddMessage(
      "current color:  " ..
          Cfg.TeammateIcon_RGB[1] .. "," .. Cfg.TeammateIcon_RGB[2] .. "," .. Cfg.TeammateIcon_RGB[3]
  )
end
...
function Console:Cmd_CROSSHAIRHIT_RGB(r, g, b)
  ...
  CONSOLE_AddMessage(
      "current color:  " ..
          Cfg.CrosshairHit_RGB[1] .. "," .. Cfg.CrosshairHit_RGB[2] .. "," .. Cfg.CrosshairHit_RGB[3]
  )
end
