...
function Hud:AmmoListOriOn()
  ...
  if Cfg.HUD_AmmoList == 3 then
      if Player._CurWeaponIndex == 2 then
          if Cfg.HUD_Ammolist_Marker_Primary then
              if not INP.IsFireSwitched() then
                  if
                      not (not Game.SwitchFire[2] and Cfg.SwitchFire[2]) or
                          not Cfg.SwitchFire[2] and Game.SwitchFire[2]
                   then
                      if Hud._weaponspri[2] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              w / 2 + (dsda + ecart - 2) * sizem * w / 1024,
                              (768 - (posiy + 1)) * h / 768,
                              sizem,
                              false,
                              color[1],
              ...
              elseif
                  not (not Game.SwitchFire[2] and Cfg.SwitchFire[2]) or not Cfg.SwitchFire[2] and Game.SwitchFire[2]
               then
                  if Hud._weaponsalt[2] then
                      Hud:QuadRGBA(
                          self._matSelectFrame,
      ...
      if Player.EnabledWeapons[2] ~= Shotgun then
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsdb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%03d", Player.Ammo.Shotgun), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Shotgun,
              colord[1],
              colord[2],
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%03d", Player.Ammo.IceBullets), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.IceBullets,
              colord[1],
              colord[2],
      ...
      if Player._CurWeaponIndex == 3 then
          if Cfg.HUD_Ammolist_Marker_Primary then
              if not INP.IsFireSwitched() then
                  if
                      not (not Game.SwitchFire[3] and Cfg.SwitchFire[3]) or
                          not Cfg.SwitchFire[3] and Game.SwitchFire[3]
                   then
              ...
              elseif
                  not (not Game.SwitchFire[3] and Cfg.SwitchFire[3]) or not Cfg.SwitchFire[3] and Game.SwitchFire[3]
               then
                  if Hud._weaponsalt[3] then
                      Hud:QuadRGBA(
                          self._matSelectFrame,
      ...
      if Player._CurWeaponIndex == 4 then
          if Cfg.HUD_Ammolist_Marker_Primary then
              if not INP.IsFireSwitched() then
                  if
                      not (not Game.SwitchFire[4] and Cfg.SwitchFire[4]) or
                          not Cfg.SwitchFire[4] and Game.SwitchFire[4]
                   then
                      if Hud._weaponspri[4] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              w / 2 + (dsda + ecart + 109) * sizem * w / 1024,
                              (768 - (posiy + 1)) * h / 768,
                              sizem,
                              false,
                              color[1],
                      ...
                      if Hud._weaponsalt[4] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              w / 2 + (dsa + ecart + 109) * sizem * w / 1024,
                              (768 - (posiy + 1)) * h / 768,
                              sizem,
                              false,
                              color[1],
              ...
              elseif
                  not (not Game.SwitchFire[4] and Cfg.SwitchFire[4]) or not Cfg.SwitchFire[4] and Game.SwitchFire[4]
               then
                  if Hud._weaponsalt[4] then
                      Hud:QuadRGBA(
                          self._matSelectFrame,
      ...
      if Player.EnabledWeapons[3] ~= StakeGunGL then
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsdb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%04d", Player.Ammo.Stakes), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Stakes,
              colord[1],
              colord[2],
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%04d", Player.Ammo.Grenades), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Grenades,
              colord[1],
              colord[2],
      ...
      if Player.EnabledWeapons[4] ~= MiniGunRL then
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsdb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%03d", Player.Ammo.MiniGun), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.MiniGun,
              colord[1],
              colord[2],
      ...
      if Player._CurWeaponIndex == 5 then
          if Cfg.HUD_Ammolist_Marker_Primary then
              if not INP.IsFireSwitched() then
                  if
                      not (not Game.SwitchFire[5] and Cfg.SwitchFire[5]) or
                          not Cfg.SwitchFire[5] and Game.SwitchFire[5]
                   then
              ...
              elseif
                  not (not Game.SwitchFire[5] and Cfg.SwitchFire[5]) or not Cfg.SwitchFire[5] and Game.SwitchFire[5]
               then
                  if Hud._weaponsalt[5] then
                      Hud:QuadRGBA(
                          self._matSelectFrame,
      ...
      if Player.EnabledWeapons[5] ~= DriverElectro then
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsdb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%04d", Player.Ammo.Shurikens), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Shurikens,
              colord[1],
              colord[2],
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%04d", Player.Ammo.Electro), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Electro,
              colord[1],
              colord[2],
      ...
      if Player.EnabledWeapons[6] ~= RifleFlameThrower then
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsdb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%04d", Player.Ammo.Rifle), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Rifle,
              colord[1],
              colord[2],
      ...
      if Player._CurWeaponIndex == 7 then
          if Cfg.HUD_Ammolist_Marker_Primary then
              if not INP.IsFireSwitched() then
                  if
                      not (not Game.SwitchFire[7] and Cfg.SwitchFire[7]) or
                          not Cfg.SwitchFire[7] and Game.SwitchFire[7]
                   then
              ...
              elseif
                  not (not Game.SwitchFire[7] and Cfg.SwitchFire[7]) or not Cfg.SwitchFire[7] and Game.SwitchFire[7]
               then
                  if Hud._weaponsalt[7] then
                      Hud:QuadRGBA(
                          self._matSelectFrame,
      ...
      if Player.EnabledWeapons[7] ~= BoltGunHeater then
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsdb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%04d", Player.Ammo.Bolt), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Bolt,
              colord[1],
              colord[2],
          ...
          Hud:DrawDigitsText1(
              w / 2 + (dsb + ecart) * sizem * w / 1024,
              (768 - (posiy - 2 * sizem)) * h / 768,
              string.sub(string.format("%04d", Player.Ammo.HeaterBomb), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.HeaterBomb,
              colord[1],
              colord[2],
                   ...
                   then
                      if Hud._weaponspri[2] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              selectpoxix,
                              (768 - ((posiy + 1) * 2 + centhfix * sizem)) * cent,
                              sizem,
                              false,
                              color[1],
                              color[2],
                      ...
                      if Hud._weaponsalt[2] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              selectpoxix,
                              (768 - ((posiy + 1) * 2 - (84 - centhfix) * sizem)) * cent,
                              sizem,
                              false,
                              color[1],
                              color[2],
      ...
      if Player.EnabledWeapons[2] ~= Shotgun then
          Hud:QuadRGBA(
              ammo1[1],
              icoposix,
              (768 - (posiy * 2 + centhfix * sizem)) * cent,
              sizem,
              false,
              prcolor[2][1],
              prcolor[2][2],
          ...
          Hud:QuadRGBA(
              ammo2[1],
              icoposix,
              (768 - (posiy * 2 - (84 - centhfix) * sizem)) * cent,
              sizem,
              false,
              alcolor[2][1],
              alcolor[2][2],
          ...
          Hud:DrawDigitsText1(
              textposix,
              (768 - (posiy * 2 + (centhfix - 3) * sizem)) * cent,
              string.sub(string.format("%03d", Player.Ammo.Shotgun), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Shotgun,
              colord[1],
          ...
          Hud:DrawDigitsText1(
              textposix,
              (768 - (posiy * 2 - (87 - centhfix) * sizem)) * cent,
              string.sub(string.format("%03d", Player.Ammo.IceBullets), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.IceBullets,
              colord[1],
                   ...
                   then
                      if Hud._weaponspri[3] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              selectpoxix,
                              (768 - ((posiy + 1) * 2 + (centhfix - nextposh) * sizem)) * cent,
                              sizem,
                              false,
                              color[1],
                              color[2],
                      ...
                      if Hud._weaponsalt[3] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              selectpoxix,
                              (768 - ((posiy + 1) * 2 - (84 - centhfix + nextposh) * sizem)) * cent,
                              sizem,
                              false,
                              color[1],
                              color[2],
                   ...
                   then
                      if Hud._weaponspri[4] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              selectpoxix,
                              (768 - ((posiy + 1) * 2 + (centhfix - (nextposh + 168) + 84) * sizem)) * cent,
                              sizem,
                              false,
                              color[1],
                              color[2],
                      ...
                      if Hud._weaponsalt[4] then
                          Hud:QuadRGBA(
                              self._matSelectFrame,
                              selectpoxix,
                              (768 - ((posiy + 1) * 2 - (84 - centhfix + (nextposh + 168) - 84) * sizem)) * cent,
                              sizem,
                              false,
                              color[1],
                              color[2],
      ...
      if Player.EnabledWeapons[3] ~= StakeGunGL then
          Hud:QuadRGBA(
              ammo1[2],
              icoposix,
              (768 - (posiy * 2 + (centhfix - nextposh) * sizem)) * cent,
              sizem,
              false,
              prcolor[3][1],
              prcolor[3][2],
          ...
          Hud:QuadRGBA(
              ammo2[2],
              icoposix,
              (768 - (posiy * 2 - (84 - centhfix + nextposh) * sizem)) * cent,
              sizem,
              false,
              alcolor[3][1],
              alcolor[3][2],
          ...
          Hud:DrawDigitsText1(
              textposix,
              (768 - (posiy * 2 + (centhfix - 3 - nextposh) * sizem)) * cent,
              string.sub(string.format("%04d", Player.Ammo.Stakes), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Stakes,
              colord[1],
          ...
          Hud:DrawDigitsText1(
              textposix,
              (768 - (posiy * 2 - (87 - centhfix + nextposh) * sizem)) * cent,
              string.sub(string.format("%04d", Player.Ammo.Grenades), -3),
              showinfi * sizem,
              Player.s_SubClass.AmmoWarning.Grenades,
              colord[1],
      ...
      if INP.Key(Keys.Home) == 2 then
          ...
          if Cfg.HUD_AmmoList == 1 then
              HUD.DrawQuadRGBA(
                  nil,
                  textposix1,
                  (768 - (posiy * 2 + (centhfix - (nextposh / 2 - 8)) * sizem)) * cent,
                  113 * sizem * w / 1024,
                  3 * h / 768,
                  0,
                  255,
              ...
              HUD.DrawQuadRGBA(
                  nil,
                  textposix1 + 55.5 * sizem * w / 1024,
                  (768 - (posiy * 2 + (centhfix + 5) * sizem)) * cent,
                  3 * w / 1024,
                  nextposh * sizem * cent,
                  0,
                  255,
          ...
          elseif Cfg.HUD_AmmoList == 3 then
              ...
              HUD.DrawQuadRGBA(
                  nil,
                  w / 2 - (dsda + ecart - 2) * sizem * w / 1024,
                  (768 - posiy + 19 * sizem) * h / 768,
                  (dsda + ecart) * sizem * 2 * w / 1024,
                  3 * h / 768,
                  0,
                  255,
                  0,
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Size: %02d", sizem * 100) .. "%")) / 2,
              h / 2.6 + HUD.GetTextHeight(),
              string.format("Size: %02d", sizem * 100) .. "%",
              "courbd",
              0,
              255,
              0,
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Vertical Position: %01d px", posiy * h / 768))) / 2,
              h / 2.6 + HUD.GetTextHeight() * 2,
              string.format("Vertical Position: %01d px", posiy * h / 768),
              "courbd",
              0,
              255,
              0,
...
function Hud:HelpKeys()
  ...
  if
      Cfg.PositioningSystem == 4 and
          (Cfg.ShowFPS or Cfg.HUD_Show_FPS or Cfg.HUD_Show_PacketLoss or Cfg.HUD_Show_Ping or
              Cfg.HUD_Show_Speedmeter == 1 or
              Cfg.HUD_Show_Speedmeter == 2 or
              Cfg.HUD_Show_Speedmeter == 3) and
          INP.Key(Keys.Home) == 2
   then
...
function Hud:KeysSounds()
      ...
      for i = 1, 2 do
          if Cfg.PositioningSystem == 1 then
              ...
              if INP.Key(Keys.Home) == 2 then
                  ...
                  elseif
                      (INP.Key(Keys.Num9) == Hud.keypressmode or INP.Key(Keys.Num3) == Hud.keypressmode) and
                          scoresposxy[i][3] < tonumber(string.format("%.01f", 1.6)) and
                          scoresposxy[i][3] > tonumber(string.format("%.01f", 0.5))
                   then
                      PlaySound2D("../Sounds/move", nil, nil, true)
                  end
              end
  ...
  if Cfg.PositioningSystem == 0 and Cfg.WeaponsPositionning and Cfg.ViewWeaponModel then
      if
          INP.Key(Keys.PgUp) == 2 and
              (INP.Key(Keys.Num4) == Hud.keypressmode or INP.Key(Keys.Num6) == Hud.keypressmode or
                  INP.Key(Keys.Num8) == Hud.keypressmode or
                  INP.Key(Keys.Num2) == Hud.keypressmode or
                  INP.Key(Keys.Num9) == Hud.keypressmode or
                  INP.Key(Keys.Num3) == Hud.keypressmode)
       then
          PlaySound2D("../Sounds/move", nil, nil, true)
      end
      if INP.Key(Keys.Home) == 2 then
  ...
  if Cfg.PositioningSystem == 2 and Cfg.HUD_AmmoList ~= 0 and INP.Key(Keys.Home) == 2 then
      ...
      if
          (INP.Key(Keys.Num8) == Hud.keypressmode or INP.Key(Keys.Num2) == Hud.keypressmode) and
              Cfg.HUD_AmmoList_Position[1] < 216 and
              Cfg.HUD_AmmoList_Position[1] > -216
       then
          PlaySound2D("../Sounds/move", nil, nil, true)
      end
  end
  if INP.Key(Keys.NumDecimal) == 2 then
      if
          INP.Key(Keys.Num8) == Hud.keypressmode or INP.Key(Keys.Num2) == Hud.keypressmode or
              INP.Key(Keys.Num3) == Hud.keypressmode or
              INP.Key(Keys.Num9) == Hud.keypressmode or
              INP.Key(Keys.Num7) == Hud.keypressmode or
              INP.Key(Keys.Num1) == Hud.keypressmode
       then
          PlaySound2D("../Sounds/move", nil, nil, true)
  ...
  if
      Cfg.PositioningSystem == 4 and
          (Cfg.ShowTimer or Cfg.HUD_Show_Ping or Cfg.ShowFPS or Cfg.HUD_Show_FPS or Cfg.HUD_Show_PacketLoss or
              Cfg.HUD_Show_Speedmeter == 1 or
              Cfg.HUD_Show_Speedmeter == 2 or
...
function Hud:HudBar()
  ...
  if Cfg.HUD_Switch_HudBar == 0 then
      ...
      self:DrawDigitsText1(
          (1024 - poshudbardigit[1]) * w / 1024,
          699 * h / 768,
          string.sub(string.format("%03d", hee), -3),
          0.8,
          Player.HealthWarning,
          colord[1],
          colord[2],
      ...
      self:DrawDigitsText1(
          (1024 - poshudbardigit[2]) * w / 1024,
          699 * h / 768,
          string.sub(string.format("%03d", armorr), -3),
          0.8,
          Player.ArmorWarning,
          colord[1],
          colord[2],
...
function Hud:SuperHud()
  ...
  if Cfg.HUD_Show_Health_Icon then
      ...
      if Cfg.HUD_HudStyle == 2 then
          if Cfg.HUD_3DIcon_Anim then
              self:QuadTrans(
                  self._matHealthQW3D[s0 + 1],
                  (1024 - qwhudposhe) * w / 1024,
                  (768 - qwhudposhhe) * h / 768,
                  qwhudsizeh / 2,
                  true,
                  transic
              )
  ...
  self:DrawDigitsText2(
      (1024 - qwhudposhed - 122 * qwhudsizehd / 2) * w / 1024,
      (768 - qwhudposhhed - 64 * qwhudsizehd / 2) * h / 768,
      string.sub(string.format("%03d", hee), -3),
      showinf * qwhudsizehd,
      Player.HealthWarning,
      colord[1],
  ...
  if Cfg.HUD_HudStyle == 2 then
      if Cfg.HUD_3DIcon_Anim then
          if Player.ArmorType == 0 then
              self:QuadTrans(
                  self._matArmorNormalQW3D[s1 + 1],
                  (1024 - qwhudposar) * w / 1024,
                  (768 - qwhudposhar) * h / 768,
                  qwhudsizea / 2,
                  true,
                  transic / 2
              )
  ...
  self:DrawDigitsText2(
      (1024 - qwhudposard - 122 * qwhudsizead / 2) * w / 1024,
      (768 - qwhudposhard - 64 * qwhudsizead / 2) * h / 768,
      string.sub(string.format("%03d", armorr), -3),
      showinf * qwhudsizead,
      Player.ArmorWarning,
      colord[1],
  ...
  if type(j) == "number" and j <= 7 and 1 <= j and Player._CurWeaponIndex == j then
          ...
          if not INP.IsFireSwitched() then
              if not (not Game.SwitchFire[j] and Cfg.SwitchFire[j]) or not Cfg.SwitchFire[j] and Game.SwitchFire[j] then
                  if Cfg.HUD_HudStyle == 2 then
                      if Cfg.HUD_3DIcon_Anim then
                          Hud:QuadTrans(
                              priammolist3D[j][s2 + 1],
                              (1024 - qwhuditemsfix1) * w / 1024,
                              (768 - qwhudposhw1) * h / 768,
                              qwhudsizew1 / 2,
                              true,
                              transic
                          )
                          Hud:QuadTrans(
                              altammolist3D[j][ams + 1],
                              (1024 - qwhuditemsfix3) * w / 1024,
                              (768 - qwhudposhw2) * h / 768,
                              qwhudsizew2 / 2,
                              true,
                              transic
                          )
                  ...
                  Hud:DrawDigitsText3(
                      (1024 - posInf - 122 * qwhudsizewd1 / 2) * w / 1024,
                      (768 - qwhudposhw1d - 64 * qwhudsizewd1 / 2) * h / 768,
                      string.sub(string.format(numcharact[j], priammolistnum[j]), -3),
                      showinf * qwhudsizewd1,
                      priammolistnumwar[j],
                      colord[1],
                      colord[2],
                      colord[3],
                  ...
                  Hud:DrawDigitsText3(
                      (1024 - posInff - 122 * qwhudsizewd2 / 2) * w / 1024,
                      (768 - qwhudposhw2d - 64 * qwhudsizewd2 / 2) * h / 768,
                      string.sub(string.format(numcharact[j], altammolistnum[j]), -3),
                      showinf * qwhudsizewd2,
                      altammolistnumwar[j],
                      colord[1],
                      colord[2],
                      colord[3],
      ...
      if Cfg.HUD_Show_CurrentWeapon_Icon then
          ...
          if Cfg.HUD_3DIcon_Anim and Cfg.HUD_HudStyle == 2 then
              Hud:QuadTrans(
                  cweapons[j][s3 + 1],
                  (1024 - qwhudposcw) * w / 1024,
                  (768 - qwhudposhcw) * h / 768,
                  qwhudsizecwd / 2,
                  true,
                  transic
              )
  ...
  if Cfg.PositioningSystem == 3 then
      ...
      if spressthiskey == true then
          ...
          for i = 1, 9 do
              ...
              if INP.Key(Keys.NumDivide) == 1 then
                  if
                      qwhuditems[i][1] ~= defaultpos[i] or qwhuditems[i][2] ~= defaultposa[i] or
                          qwhuditems[i][3] ~= defaultsiz[i]
                   then
                      nosavecheck = true
                  end
          ...
          if checkitem[it] == true then
              if
                  qwhuditems[it][1] < 1024 - sizemarker * qwhuditems[it][3] / 2 and
                      qwhuditems[it][1] > 1 + sizemarker * qwhuditems[it][3] / 2
               then
              ...
              if
                  qwhuditems[it][2] < 768 - 64 * qwhuditems[it][3] / 2 and
                      qwhuditems[it][2] > 1 + 64 * qwhuditems[it][3] / 2
               then
              ...
              if
                  INP.Key(Keys.Num8) == 3 or INP.Key(Keys.Num2) == 3 or INP.Key(Keys.Num6) == 3 or
                      INP.Key(Keys.Num4) == 3 or
                      INP.Key(Keys.Num9) == 3 or
                      INP.Key(Keys.Num3) == 3
               then
                  Hud.movespeedstarttime = 0
                  Hud.movespeedstart = false
              ...
              HUD.SetFont("courbd", 20)
              HUD.PrintXY(
                  (w - HUD.GetTextWidth(qwhuditemsname[it] .. " Size: " .. qwhuditems[it][3] * 100 .. "%")) / 2,
                  h / 2.6,
                  qwhuditemsname[it] .. " Size: " .. qwhuditems[it][3] * 100 .. "%",
                  "courbd",
                  0,
                  255,
                  0,
              ...
              HUD.PrintXY(
                  (w - HUD.GetTextWidth(string.format("Vertical Position: %.01f px", qwhuditems[it][2] * h / 768))) /
                      2,
                  h / 2.6 + HUD.GetTextHeight(),
                  string.format("Vertical Position: %.01f px", qwhuditems[it][2] * h / 768),
                  "courbd",
                  0,
                  255,
                  0,
              ...
              HUD.PrintXY(
                  (w -
                      HUD.GetTextWidth(
                          string.format("Horinzontal Position: %.01f px", (qwhuditems[it][1] - 512) * w / 1024)
                      )) /
                      2,
                  h / 2.6 + HUD.GetTextHeight() * 2,
                  string.format("Horinzontal Position: %.01f px", (qwhuditems[it][1] - 512) * w / 1024),
              ...
              if Hud.SuperHud_Item == it then
                  ...
                  HUD.DrawQuadRGBA(
                      nil,
                      (1024 - markerfix - sizemarker * qwhuditems[it][3] / 2) * w / 1024,
                      (768 - (qwhuditems[it][2] - 30.5 * qwhuditems[it][3]) - 64 * qwhuditems[it][3] / 2) * h / 768,
                      sizemarker * qwhuditems[it][3] * w / 1024,
                      3 * qwhuditems[it][3] * h / 768,
                      0,
                      255,
                      0,
                      255
                  ...
                  HUD.DrawQuadRGBA(
                      nil,
                      (1024 - (markerfix - qwposmarkerref * qwhuditems[it][3]) - sizemarker * qwhuditems[it][3] / 2) *
                          w /
                          1024,
                      (768 - qwhuditems[it][2] - 64 * qwhuditems[it][3] / 2) * h / 768,
                      3 * qwhuditems[it][3] * w / 1024,
                      64 * qwhuditems[it][3] * h / 768,
                      0,
                      255,
                      0,
                      255
...
function Hud:Shape(item, enable, morethantwo)
  ...
  if Cfg.PositioningSystem == 5 then
      if INP.Key(Keys.Home) == 2 then
          ...
          if
              INP.Key(Keys.Num8) == 3 or INP.Key(Keys.Num2) == 3 or INP.Key(Keys.Num6) == 3 or INP.Key(Keys.Num4) == 3 or
                  INP.Key(Keys.Num9) == 3 or
                  INP.Key(Keys.Num3) == 3
           then
              Hud.movespeedstarttime = 0
          ...
          HUD.SetFont("courbd", 20)
          HUD.PrintXY(
              (w - HUD.GetTextWidth(itemsname[it] .. " Size: " .. itpos[it][3] * 100 .. "%")) / 2,
              h / 2.6,
              itemsname[it] .. " Size: " .. itpos[it][3] * 100 .. "%",
              "courbd",
              0,
              255,
              0,
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Vertical Position: %.01f px", itpos[it][2] * h / 768))) / 2,
              h / 2.6 + HUD.GetTextHeight(),
              string.format("Vertical Position: %.01f px", itpos[it][2] * h / 768),
              "courbd",
              0,
              255,
              0,
          ...
          HUD.PrintXY(
              (w - HUD.GetTextWidth(string.format("Horinzontal Position: %.01f px", itpos[it][1] * w / 1024))) / 2,
              h / 2.6 + HUD.GetTextHeight() * 2,
              string.format("Horinzontal Position: %.01f px", itpos[it][1] * w / 1024),
              "courbd",
              0,
              255,
              0,
  ...
  if item == "flag" or item == "all" then
      if Player.Team == 0 then
          ...
          self:QuadRGBA(
              Hud._matPlayerHasFlag,
              w / 2 + itpos[1][1] * w / 1024,
              h / 2 - itpos[1][2] * h / 768,
              itpos[1][3],
              true,
              cr[1],
  ...
  if item == "modifier" or item == "all" then
      ...
      self:QuadRGBA(
          Hud._matPlayerHasPowerUp,
          w / 2 + itpos[2][1] * w / 1024,
          h / 2 - itpos[2][2] * h / 768,
          itpos[2][3],
          true,
          255,
      ...
      if enable then
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[2][1] * w / 1024,
              h / 2 - fixposh - itpos[2][2] * h / 768,
              string.sub(string.format("%d", modifier), -3),
              0.4 * itpos[2][3],
              nil,
              255,
              255,
  ...
  if item == "immunity" or item == "all" then
      ...
      if enable then
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[3][1] * w / 1024,
              h / 2 - fixposh - itpos[3][2] * h / 768,
              string.sub(string.format("%d", immunity), -3),
              0.4 * itpos[3][3],
              nil,
              255,
              255,
  ...
  if item == "rage" or item == "all" then
      ...
      if enable then
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[4][1] * w / 1024,
              h / 2 - fixposh - itpos[4][2] * h / 768,
              string.sub(string.format("%d", rage), -3),
              0.4 * itpos[4][3],
              nil,
              255,
              255,
  ...
  if item == "good" or item == "all" then
      ...
      if medalg < 10 then
          for i = 1, medalg do
              self:QuadRGBA(
                  Hud._matPlayerExcellentMedal,
                  w / 2 + itpos[5][1] * w / 1024 + 33 * itpos[5][3] * w / 1024 + rep - center,
                  h / 2 - morethantwo - itpos[5][2] * h / 768,
                  itpos[5][3],
                  true,
                  255,
                  255,
          ...
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[5][1] * w / 1024,
              h / 2 - morethantwo - fixposh - itpos[5][2] * h / 768,
              string.sub(string.format("%d", medalg), -3),
              fixsize,
              nil,
              255,
              255,
  ...
  if item == "nomercy" then
      ...
      if medalnm < 10 then
          ...
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[5][1] * w / 1024,
              h / 2 - morethantwo - fixposh - itpos[5][2] * h / 768,
              string.sub(string.format("%d", medalnm), -3),
              fixsize,
              nil,
              255,
              255,
  ...
  if item == "sweet" then
      ...
      if medals < 10 then
          ...
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[5][1] * w / 1024,
              h / 2 - morethantwo - fixposh - itpos[5][2] * h / 768,
              string.sub(string.format("%d", medals), -3),
              fixsize,
              nil,
              255,
              255,
  ...
  if item == "stylish" then
      ...
      if medalst < 10 then
          ...
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[5][1] * w / 1024,
              h / 2 - morethantwo - fixposh - itpos[5][2] * h / 768,
              string.sub(string.format("%d", medalst), -3),
              fixsize,
              nil,
              255,
              255,
  ...
  if item == "all" then
      HUD.DrawQuadRGBA(
          nil,
          w / 2 + (itpos[it][1] - sizerx / 2 * itpos[it][3]) * w / 1024,
          h / 2 - (itpos[it][2] + 1.5) * h / 768,
          64 * itpos[it][3] * w / 1024,
          3 * h / 768,
          0,
          255,
          0,
      ...
      HUD.DrawQuadRGBA(
          nil,
          w / 2 + (itpos[it][1] - 1) * w / 1024,
          h / 2 - (itpos[it][2] + sizery / 2 * itpos[it][3]) * h / 768,
          3 * w / 1024,
          64 * itpos[it][3] * h / 768,
          0,
          255,
      ...
      if Hud.Shape_Item == 5 then
          Hud:DrawDigitsText3(
              w / 2 - fixposw + itpos[5][1] * w / 1024,
              h / 2 - fixposh - itpos[5][2] * h / 768,
              string.sub(string.format("%d", 10), -3),
              fixsize,
              nil,
              255,
              255,
