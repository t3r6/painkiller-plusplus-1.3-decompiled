          ...
          if Game.PlayerStats[o.ClientID].Version then
              for id, ps in Game.PlayerStats, nil do
                  if ps and ps.Player ~= nil and ps.Spectator == 0 then
                      ...
                      if
                          currentweaponindex == 2 and ps.Player.Ammo.Shotgun ~= nil and
                              ps.Player.Ammo.IceBullets ~= nil
                       then
                      ...
                      if
                          ps.ClientID ~= nil and ps.Player.Health ~= nil and ps.Player.Armor ~= nil and
                              currentweaponindex ~= nil and
                              ammo1 ~= nil and
                              ammo2 ~= nil
                       then
                          local txt =
  ...
  if Game:IsServer() then
      for id, ps in Game.PlayerStats, nil do
          if ps and ps.Player ~= nil and ps.Spectator == 0 then
              ...
              if
                  ps.ClientID ~= nil and ps.Player.Health ~= nil and ps.Player.Armor ~= nil and currentweapon ~= nil and
                      ammo1 ~= nil and
                      ammo2 ~= nil
               then
                                  ...
                                  ps.ClientID ..
                                      "," ..
                                          attack_type.attacktype ..
                                              "," ..
                                                  attack_type.hits ..
                                                      "," .. attack_type.shots .. "," .. attack_type.damage
                              SendNetMethod(Game.ConsoleClientMessage, o.ClientID, true, true, ServerID, txt, 0)
                          end
                      end
                  end
...
function Game:AddToStats(clientid, attacktype, deltahit, deltashot, deltadamage)
  ...
  Game.Stats[clientid].PlayerWepStats[attacktype].attacktype = attacktype
  Game.Stats[clientid].PlayerWepStats[attacktype].hits =
      Game.Stats[clientid].PlayerWepStats[attacktype].hits + deltahit
  Game.Stats[clientid].PlayerWepStats[attacktype].shots =
      Game.Stats[clientid].PlayerWepStats[attacktype].shots + deltashot
  Game.Stats[clientid].PlayerWepStats[attacktype].damage =
      Game.Stats[clientid].PlayerWepStats[attacktype].damage + deltadamage
end
