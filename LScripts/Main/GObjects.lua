...
function GObjects:AddToTables(obj)
    ...
    if
        obj.BaseObj == "CheckPoint.CItem" or obj.BaseObj == "EndOfGame.CItem" or obj.BaseObj == "EndOfLevel.CItem" or
            obj.BaseObj == "pentakl.CItem" or
            obj.BaseObj == "C5L3_Krzyz.CItem"
     then
